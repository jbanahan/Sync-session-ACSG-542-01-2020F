...
class PieceSetTest < ActiveSupport::TestCase
  ...
  test "keys must be unique" do
    ...
    assert new.errors[:base].include?("PieceSet with these keys already exists. (Product: 1, OrderLine: 999, Shipment: , Inventory: , Adjustment: )"),
    ...
    assert new.errors[:base].include?("PieceSet with these keys already exists. (Product: 1, OrderLine: , Shipment: , Inventory: , Adjustment: )"),
    ...
    assert new.errors[:base].include?("PieceSet with these keys already exists. (Product: 1, OrderLine: , Shipment: 999, Inventory: , Adjustment: )"),
    ...
    assert new.errors[:base].include?("PieceSet with these keys already exists. (Product: 1, OrderLine: 999, Shipment: 999, Inventory: , Adjustment: )"),
    ...
    assert new.errors[:base].include?("PieceSet with these keys already exists. (Product: 1, OrderLine: , Shipment: 999, Inventory: 999, Adjustment: )"),
    ...
    assert new.errors[:base].include?("PieceSet with these keys already exists. (Product: 1, OrderLine: , Shipment: 999, Inventory: 999, Adjustment: adj)"),
