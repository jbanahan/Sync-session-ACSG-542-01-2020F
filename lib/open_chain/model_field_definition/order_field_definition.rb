module OpenChain; module ModelFieldDefinition; module OrderFieldDefinition
  def add_order_fields
    add_fields CoreModule::ORDER, [
      ...
      [31, :ord_comment_last_7_days, :comment_last_7_days, "Comments - Last 7 Days", :data_type=>:string, :read_only=>true, :history_ignore=>true,
      ...
      [32, :ord_comment_last_24_hrs, :comment_last_24_hrs, "Comments - Last 24 Hours", :data_type=>:string, :read_only=>true, :history_ignore=>true,
      ...
      [33, :ord_comment_last_25, :comment_last_25, "Comments - Last 25", :data_type=>:string, :read_only=>true, :history_ignore=>true,
      ...
      [35,:ord_cust_ord_status, :customer_order_status, "Customer Order Status",{:data_type=>"string"}],
    ]
