module OpenChain; module ModelFieldDefinition; module OrderFieldDefinition
  def add_order_fields
    add_fields CoreModule::ORDER, [
      ...
      [31, :ord_comment_last_7_hrs, :comment_last_7_hrs, "Last 7 Hours of Comments", :data_type=>:string, :read_only=>true,
      ...
      [32, :ord_comment_last_14_hrs, :comment_last_14_hrs, "Last 14 Hours of Comments", :data_type=>:string, :read_only=>true,
      ...
      [33, :ord_comment_last_24_hrs, :comment_last_24_hrs, "Last 24 Hours of Comments", :data_type=>:string, :read_only=>true,
