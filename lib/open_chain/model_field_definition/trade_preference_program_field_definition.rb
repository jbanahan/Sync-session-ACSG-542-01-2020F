module OpenChain; module ModelFieldDefinition; module TradePreferenceProgramFieldDefinition
  def add_trade_preference_program_fields
    ...
    add_fields CoreModule::TRADE_PREFERENCE_PROGRAM, make_country_arrays(100,'tpp_origin','trade_preference_programs','origin_country','Origin')
    add_fields CoreModule::TRADE_PREFERENCE_PROGRAM, make_country_arrays(200,'tpp_destination','trade_preference_programs','destination_country','Destination')
  end
end; end; end
