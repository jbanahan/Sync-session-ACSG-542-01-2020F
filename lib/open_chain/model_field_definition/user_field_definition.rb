module OpenChain; module ModelFieldDefinition; module UserFieldDefinition
  def add_user_fields
    add_fields CoreModule::USER, [
        ...
        [18, :usr_commercial_invoice_edit, :commercial_invoice_edit, "Commercial Invoice Edit", {data_type: :boolean}],
        [19, :usr_commercial_invoice_view, :commercial_invoice_view, "Commercial Invoice View", {data_type: :boolean}],
