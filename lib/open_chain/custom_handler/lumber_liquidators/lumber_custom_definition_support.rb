...
module OpenChain; module CustomHandler; module LumberLiquidators; module LumberCustomDefinitionSupport
  CUSTOM_DEFINITION_INSTRUCTIONS = {
    ...
    prodven_carb: {cdef_uid:'prodven_carb',label:'CARB Statement',data_type: :string, module_type:'ProductVendorAssignment'},
    prodven_patent: {cdef_uid:'prodven_patent',label:'Patent Statement',data_type: :string, module_type:'ProductVendorAssignment'},
    ...
    ord_asn_arrived: {label: 'ASN - Arrived', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_booking_approved: {label: 'ASN - Booking Approved', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_booking_submitted: {label: 'ASN - Booking Submitted', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_departed: {label: 'ASN - Departed', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_discharged: {label: 'ASN - Discharged', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_empty_return: {label: 'ASN - Empty Return', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_fcr_created: {label: 'ASN - FCR Created', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_gate_in: {label: 'ASN - Full In Gate at Origin', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_gate_out: {label: 'ASN - Full Outgate - Discharge Port', data_type: :datetime, module_type: 'Order', read_only: true},
    ord_asn_loaded_at_port: {label: 'ASN - Loaded At Port', data_type: :datetime, module_type: 'Order', read_only: true},
    ...
    ord_comp_docs_posted_by: {label: 'Compliance Docs Posted By', data_type: :integer, module_type: 'Order', read_only: true, is_user: true},
    ...
    ord_forecasted_handover_date: {cdef_uid:'ord_forecasted_ship_window_end',label: "Forecasted Handover Date", data_type: :date, module_type: "Order", read_only: true},
    ord_forecasted_ship_window_start: {cdef_uid:'ord_forecasted_ship_window_start',label:"Forecasted Ship Window Start", data_type: :date, module_type: "Order", read_only: true},
    ...
    ord_internal_production_articles: {cdef_uid:'ord_internal_production_articles',label:"Internal Production - Articles Used", data_type: :text, module_type: "Order"},
    ord_internal_production_orders: {cdef_uid:'ord_internal_production_orders',label:"Internal Production - Orders Used", data_type: :text, module_type: "Order"},
    ...
    ord_production_delay_first_reported: {label: "Production Delay First Reported", data_type: :date, module_type: 'Order'},
    ...
    ord_testing_date_planned: {label: "Testing Date - Planned", data_type: :date, module_type: "Order"},
    ord_testing_date_completed: {label: "Testing Date - Completed", data_type: :date, module_type: "Order"},
    ...
    ord_delay_reason: { label: "Delay Reason", data_type: :string, module_type: "Order"},
    ord_delay_dispo: { label: "Delay Disposition", data_type: :string, module_type: "Order"},
