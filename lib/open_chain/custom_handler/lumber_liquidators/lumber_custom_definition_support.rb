...
module OpenChain; module CustomHandler; module LumberLiquidators; module LumberCustomDefinitionSupport
  CUSTOM_DEFINITION_INSTRUCTIONS = {
    ...
    ordln_old_art_number: { label: 'Old Article Number', data_type: :string, module_type: 'OrderLine'},    ordln_part_name: {label: 'Part Name', data_type: :string, module_type: 'OrderLine'},
