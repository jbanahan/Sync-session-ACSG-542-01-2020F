...
module OpenChain; module CustomHandler; module LumberLiquidators; class LumberPpqReport
  ...
  def query start_date, end_date
    <<-SQL
      SELECT e.customer_name 'Importer Name', e.entry_number 'Entry Number', e.master_bills_of_lading 'B/L No(s)', e.container_numbers 'Container No(s)', e.arrival_date 'Arrival Date', i.mfid 'Manufacturer ID', l.part_number 'Part No', l.po_number 'PO No', t.hts_code 'HTS No',
      lc.detailed_description 'Description', lc.name 'Name of Constituent Element',lc.quantity 'Quantity of Constituent Element', lc.unit_of_measure 'UOM', 0  'Percent of Constituent Element', lc.value  'PGA Line Value', lc.genus  'Scientific Genus Name', lc.species  'Scientific Species Name',
