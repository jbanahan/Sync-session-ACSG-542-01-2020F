...
module OpenChain; module CustomHandler; module Vandegrift; class KewillUpdatedTariffRequester
  ...
  def self.run_schedulable opts = {}
    ...
    poll do |last_run, current_run|
      ...
      client.request_updated_tariff_classifications last_run, current_run, aws_data[:s3_bucket], aws_data[:s3_path], aws_data[:sqs_queue]
    end
  end
  ...
  def self.aws_context_data proxy_client, date, opts
    ...
    default_aws_data = proxy_client.aws_context_hash "json", path_date: date, parser_identifier: "kewill_tariffs"
