...
module OpenChain; module CustomHandler; module Pepsi; module PepsiCustomDefinitionSupport
  CUSTOM_DEFINITION_INSTRUCTIONS = {
    ...
    class_fta_criteria: {label: 'FTA Criteria', data_type: :string, module_type: 'Classification'},
    ...
    prod_base_customs_description: {label: 'Base Customs Description', data_type: :text, module_type:'Product',rank:1500},
    ...
    prod_fss_code: {label:'FSS Code',data_type: :string, module_type: 'Product', rank:1000},
