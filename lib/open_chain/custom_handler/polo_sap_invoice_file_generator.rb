    ...
    class PoloSapInvoiceFileGenerator
      ...
      RL_INVOICE_CONFIGS ||= {
        :rl_canada => {name: "RL Canada", tax_id: '806167003RM0001', start_date: Date.new(2013, 6, 01), 
          email_to: ["william.walsh@ralphlauren.com", "terri.scalea@ralphlauren.com", "brian.fenelli@ralphlauren.com", "Liz.Wade@RalphLauren.com", "saudah.ahmed@ralphlauren.com", "accounting-ca@vandegriftinc.com"],
        ...
        :club_monaco => {name: "Club Monaco", tax_id: '866806458RM0001', start_date: Date.new(2014, 5, 23), email_to: ["jude.belas@ralphlauren.com", "william.walsh@ralphlauren.com", "terri.scalea@ralphlauren.com", "Liz.Wade@RalphLauren.com", "saudah.ahmed@ralphlauren.com", "raul.salvador@ralphlauren.com", "accounting-ca@vandegriftinc.com"],
        ...
        :factory_stores => {name: "Polo Factory Stores", tax_id: '806167003RM0002', start_date: Date.new(2016,3,25),
          email_to: ["jude.belas@ralphlauren.com", "william.walsh@ralphlauren.com", "terri.scalea@ralphlauren.com", "Liz.Wade@RalphLauren.com", "saudah.ahmed@ralphlauren.com", "raul.salvador@ralphlauren.com", "accounting-ca@vandegriftinc.com"],
