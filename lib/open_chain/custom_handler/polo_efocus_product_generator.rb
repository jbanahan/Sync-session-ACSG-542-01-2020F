...
"
  ...
  def self.cdefs
    [:bartho_customer_id, :test_style, :season, :product_area, :msl_board_number, :fiber_content, :knit_woven, :semi_precious, :semi_precious_type, :telescopic_shaft, :unit_price] + cdefs_range_1 + cdefs_range_2
  end
