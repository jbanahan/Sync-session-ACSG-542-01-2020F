    ...
    module AnnInc
      module AnnCustomDefinitionSupport
        CUSTOM_DEFINITION_INSTRUCTIONS = {
          ...
          :classification_type=>{:label=>"Classification Type",:data_type=>:string,:module_type=>'Classification',cdef_uid: :class_classification_type},
          ...
          :percent_of_value=>{:label=>'Percent of Value',:data_type=>:integer,:module_type=>'TariffRecord', cdef_uid: :hts_percent_of_value},
          :key_description=>{:label=>'Key Description',:data_type=>:text,:module_type=>'TariffRecord', cdef_uid: :hts_key_description},
