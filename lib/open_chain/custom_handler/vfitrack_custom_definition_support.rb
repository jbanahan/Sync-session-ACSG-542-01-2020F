...
module OpenChain; module CustomHandler; module VfitrackCustomDefinitionSupport
  CUSTOM_DEFINITION_INSTRUCTIONS = {
    ...
    shp_non_dutiable_amount: { label: "Non-Dutiable Amount", data_type: :decimal, module_type: "Shipment", cdef_uid: "shp_non_duitable_amount"},
    ...
    prod_fda_container_type: {label: "FDA Container Type", data_type: :string, module_type: "Product", cdef_uid: "prod_fda_container_type"},
    prod_fda_items_per_inner_container: {label: "FDA Items Per Inner Container", data_type: :decimal, module_type: "Product", cdef_uid: "prod_fda_items_per_inner_container"},
    ...
    prod_fda_contact_title: {label: "FDA Contact Title", data_type: :string, module_type: "Product", cdef_uid: "prod_fda_contact_title"},
    ...
    prod_fda_brand_name: {label: "FDA Brand Name", data_type: :string, module_type: "Product", cdef_uid: "prod_fda_brand_name"},
    prod_fda_model_number: {label: "FDA Model Number", data_type: :string, module_type: "Product", cdef_uid: "prod_fda_model_number"},
    prod_fda_manufacture_date: {label: "FDA Manfacture Date", data_type: :date, module_type: "Product", cdef_uid: "prod_fda_manufacture_date"},
    prod_fda_exclusion_reason: {label: "FDA Exclusion Reason", data_type: :text, module_type: "Product", cdef_uid: "prod_fda_exclusion_reason"},
    prod_fda_unknown_reason: {label: "FDA Unknown Reason", data_type: :text, module_type: "Product", cdef_uid: "prod_fda_unknown_reason"},
    prod_fda_accession_number: {label: "FDA Accession Number", data_type: :string, module_type: "Product", cdef_uid: "prod_fda_accession_number"},
    prod_fda_manufacturer_name: {label: "FDA Manufacturer Name", data_type: :string, module_type: "Product", cdef_uid: "prod_fda_manufacturer_name"},
    prod_fda_warning_accepted: {label: "FDA Warning Accepted?", data_type: :boolean, module_type: "Product", cdef_uid: "prod_fda_warning_accepted"},
    prod_lacey_component_of_article: {label: "Lacey Component Of Article", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_component_of_article"},
    prod_lacey_genus_1: {label: "Lacey Genus 1", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_genus_1"},
    prod_lacey_species_1: {label: "Lacey Species 1", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_species_1"},
    prod_lacey_genus_2: {label: "Lacey Genus 2", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_genus_2"},
    prod_lacey_species_2: {label: "Lacey Species 2", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_species_2"},
    prod_lacey_country_of_harvest: {label: "Lacey Country of Harvest", data_type: :string, module_type: "Product", cdef_uid: "prod_country_of_harvest"},
    prod_lacey_quantity: {label: "Lacey Quantity", data_type: :decimal, module_type: "Product", cdef_uid: "prod_lacey_quantity"},
    prod_lacey_quantity_uom: {label: "Lacey Quantity UOM", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_quantity_uom"},
    prod_lacey_percent_recycled: {label: "Lacey Percent Recycled", data_type: :decimal, module_type: "Product", cdef_uid: "prod_lacey_percent_recycled"},
    prod_lacey_preparer_name: {label: "Lacey Preparer Name", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_preparer_name"},
    prod_lacey_preparer_email: {label: "Lacey Preparer Email", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_preparer_email"},
    prod_lacey_preparer_phone: {label: "Lacey Preparer Phone", data_type: :string, module_type: "Product", cdef_uid: "prod_lacey_preparer_phone"},
    ...
    prod_cvd_case_2: {label: "CVD Case Number 2", data_type: :string, module_type: "Product", cdef_uid: "prod_cvd_case_2"},
    prod_cvd_disclaimed: {label: "CVD Dislaimed?", data_type: :boolean, module_type: "Product", cdef_uid: "prod_cvd_disclaimed"},
    ...
    class_binding_ruling_number: {label: "Binding Ruling Number", data_type: :string, module_type: "Classification", cdef_uid: "class_binding_ruling_number"},
