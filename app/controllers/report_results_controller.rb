class ReportResultsController < ApplicationController
  ...
  def index
    ...
    [CustomReportEntryInvoiceBreakdown, CustomReportBillingAllocationByValue, CustomReportBillingStatementByPo, CustomReportContainerListing, CustomReportEntryBillingBreakdownByPo].each do |rpt|
