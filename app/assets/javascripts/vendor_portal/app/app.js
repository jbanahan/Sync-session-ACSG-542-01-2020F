...
angular.module("vendor_portal/partials/main.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("vendor_portal/partials/main.html",
    "<div class=\"container\"><div class=\"row\"><div class=\"col-md-12 text-center\"><a ui-sref=\"main\"><img src=\"/logo.png\" alt=\"Logo\"></a><br><h1>Vendor Portal</h1></div></div><div class=\"row\"><div class=\"col-md-8\"><chain-vp-order-panel></chain-vp-order-panel></div><div class=\"col-md-4\"><div class=\"panel panel-default\"><div class=\"panel-heading\"><h3 class=\"panel-title\">Surveys</h3></div><div class=\"panel-body text-muted text-center\"><strong>Coming Soon!</strong></div></div><div class=\"panel panel-primary\"><div class=\"panel-heading\"><h3 class=\"panel-title\">Settings</h3></div><div class=\"panel-body\"><a data-toggle=\"modal\" href=\"#modal-id\">Change Password</a><div class=\"modal fade\" id=\"modal-id\"><div class=\"modal-dialog\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button><h4 class=\"modal-title\">Change Password</h4></div><div class=\"modal-body\"><div class=\"form-group\"><label for=\"np\">New Password</label><input type=\"password\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"np\">Confirm New Password</label><input type=\"password\" class=\"form-control\"></div></div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button> <button type=\"button\" class=\"btn btn-primary\">Change</button></div></div></div></div></div></div></div></div><div class=\"row\"><div class=\"col-md-6\"></div><div class=\"col-md-6\"></div></div></div>");
}]);
