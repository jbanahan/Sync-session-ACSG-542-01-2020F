//! ChainCommon
//! Build Time: Fri Sep 23 2016 23:21:31 GMT-0400 (EDT)
//! Git SHA: 6f7f5057f627f38a21852a77ce5bef3ab44528d5
//! Git Branch: admin_client
  ...
  app.factory('chainApiSvc', [
    '$http', '$q', '$sce', '$location', '$rootScope', '$window', function($http, $q, $sce, $location, $rootScope, $window) {
      ...
      publicMethods.Shipment.load = function(id, queryOpts) {
        ...
        defaultQueryOpts = {
          include: 'lines,booking_lines,order_lines'
        };
    ...
    'chainApiSvc', function(chainApiSvc) {
      return {
        ...
        link: function(scope, el, attrs) {
          ...
          return scope.showModal = function(obj) {
