...
var OCSurvey = (function() {
  return {
    addQuestion: function(id,content,choices,attachments,warning, require_comment, require_attachment, comment_required_for_choices, attachment_required_for_choices) {
      ...
      h += "Require respondant to add a comment if choice is one of:<br><textarea id='rafc_"+mid+"' name='survey[questions_attributes]["+mid+"][comment_required_for_choices]' rows='3'>" + comment_required_for_choices + "</textarea>"
      ...
      h += "Require respondant to add an attachment if choice is one of:<br><textarea id='rafc_"+mid+"' name='survey[questions_attributes]["+mid+"][attachment_required_for_choices]' rows='3'>" + attachment_required_for_choices + "</textarea>"
