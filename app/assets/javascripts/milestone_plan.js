var OpenChainMilestonePlan = (function() {
  ...
  var addRow = function(previousRow,json_data) {
    ...
    var h = "<tr id='milestone_row_"+my_index+"' style='display:none;' class='definition_row' row_index='"+my_index+"'>";
      h += "<td><a href='#' class='add_row'><img src='/assets/green_plus_24.png' alt='Add Row' title='Add Row' /></a>&nbsp;<a href='#' class='remove_row'><img src='/assets/gray_minus_24.png' alt='Remove Row' title='Remove Row'/></a>&nbsp;<a href='#' class='edit_row'><img src='/assetsblue_edit_24.png' title='Edit' alt='Edit'/></a><input type='hidden' name='[milestone_definition_rows]["+my_index+"][display_rank]' value='"+json_data.display_rank+"'/></td>";
