  ...
  app.config([
    '$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
      ...
      return $stateProvider.state('main', {
        ...
        url: '/error',
        templateUrl: "chain_vendor_maint/partials/error.html"
      });
    }
  ]);
...
angular.module("ChainVendorMaint-Templates", ["chain_vendor_maint/partials/addresses.html", "chain_vendor_maint/partials/chain-cvm-nav.html", "chain_vendor_maint/partials/error.html", "chain_vendor_maint/partials/folders.html", "chain_vendor_maint/partials/orders.html", "chain_vendor_maint/partials/products.html", "chain_vendor_maint/partials/show.html"]);
...
angular.module("chain_vendor_maint/partials/chain-cvm-nav.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("chain_vendor_maint/partials/chain-cvm-nav.html",
    "<div class=\"row chain-cvm-nav\"><div class=\"col-md-12 text-center\"><div class=\"btn-group\"><button class=\"btn btn-secondary\" ui-sref=\"show({id:vendor.id})\">Attributes</button> <button class=\"btn btn-secondary\" ui-sref=\"addresses({id:vendor.id})\">Addresses</button> <button class=\"btn btn-secondary\" ui-sref=\"products({id:vendor.id})\">Products</button> <button class=\"btn btn-secondary\" ui-sref=\"orders({id:vendor.id})\">Orders</button> <button class=\"btn btn-secondary\" ui-sref=\"folders({id:vendor.id})\">Attachments/Comments/Folders</button> <button class=\"btn btn-secondary\" ng-show=\"isAdmin\" ng-click=\"goToUsers(vendor.id)\">Users</button></div></div></div>");
}]);

angular.module("chain_vendor_maint/partials/error.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("chain_vendor_maint/partials/error.html",
    "<div class=\"container\"><div class=\"row\"><h1 class=\"text-center\">Whoops! Something has gone wrong.</h1></div><div class=\"row\"><div class=\"col-12\"><p>Reach out to our support and let them know you're seeing this page.</p></div></div></div>");
}]);
...
angular.module("chain_vendor_maint/partials/orders.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("chain_vendor_maint/partials/orders.html",
    "<chain-loading-wrapper loading-flag=\"{{loading}}\"><div class=\"container\"><div class=\"row\"><h1 class=\"text-center\">{{vendor.cmp_name}}</h1></div><chain-cvm-nav active-module=\"Orders\" vendor=\"vendor\"></chain-cvm-nav><div class=\"row\"><div class=\"col-md-12\"><chain-search-panel name=\"Orders\" api-object-name=\"Order\" base-search-setup-function=\"baseSearch\" page-uid=\"vendor-order\" bulk-edit=\"true\" page-uid-cache-prefix=\"vendor.id\"></chain-search-panel></div></div></div></chain-loading-wrapper>");
}]);
...
angular.module("chain_vendor_maint/partials/products.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("chain_vendor_maint/partials/products.html",
    "<chain-loading-wrapper loading-flag=\"{{loading}}\"><div class=\"container\"><div class=\"row\"><h1 class=\"text-center\">{{vendor.cmp_name}}</h1></div><chain-cvm-nav active-module=\"Products\" vendor=\"vendor\"></chain-cvm-nav><div class=\"row\"><div class=\"col-md-12\"><chain-search-panel name=\"Products\" api-object-name=\"ProductVendorAssignment\" base-search-setup-function=\"baseSearch\" page-uid=\"{{pageUid}}\" bulk-edit=\"true\" page-uid-cache-prefix=\"vendor.id\"><chain-bulk-edit page-uid=\"{{pageUid}}\" button-classes=\"btn btn-secondary btn-sm\" api-object-name=\"ProductVendorAssignment\"></chain-search-panel></div></div></div></chain-loading-wrapper>");
}]);
...
angular.module("chain_vendor_maint/partials/show.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("chain_vendor_maint/partials/show.html",
    "<chain-loading-wrapper loading-flag=\"{{loading}}\"><div class=\"container\"><div class=\"row\"><h1 class=\"text-center\">{{vendor.cmp_name}}</h1></div><chain-cvm-nav active-module=\"Attributes\" vendor=\"vendor\"></chain-cvm-nav><div class=\"row\"><div class=\"col-md-12\"><div class=\"card\"><div class=\"card-header\">Attributes</div><ul class=\"list-group\" ng-if=\"vendor\"><li class=\"list-group-item\" ng-repeat=\"fld in dict.fieldsByRecordType(dict.recordTypes.Company) | chainViewFields:hiddenFields:true track by fld.uid\"><label class=\"control-label\">{{fld.label}}</label><p class=\"form-control-static\"><chain-field-input model=\"vendor\" field=\"fld\" input-class=\"form-control\"></chain-field-input></p></li></ul><div class=\"card-footer text-right\"><chain-state-toggle-buttons toggle-callback=\"reload\" button-classes=\"btn-sm\" api-object-name=\"Vendor\" object=\"vendor\"></chain-state-toggle-buttons><button class=\"btn btn-sm btn-secondary\" ng-click=\"cancel(vendor)\">Cancel</button> <button class=\"btn btn-sm btn-success\" ng-click=\"save(vendor)\">Save</button></div></div></div></div></div></chain-loading-wrapper>");
}]);

(function() {
  angular.module('ChainVendorMaint').controller('MainCtrl', [
    '$scope', '$location', '$state', function($scope, $location, $state) {
      var i, len, s, seg, segments, transitioned, url;
      url = $location.absUrl();
      segments = url.split('/');
      transitioned = false;
