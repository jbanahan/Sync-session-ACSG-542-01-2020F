...
(function() {
  ...
  app.factory('chainApiSvc', [
    '$http', '$q', '$sce', '$location', function($http, $q, $sce, $location) {
      var newAttachmentClient, newCommentClient, newCoreModuleClient, newCountryClient, newMessageClient, newSupportClient, newUserClient, newUserManualClient, publicMethods;
      publicMethods = {};
