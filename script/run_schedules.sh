...
curl --header "Content-Type: application/json" -d '{}' --header "Accept: application/json" --header "Authorization: Token token=\"integration:zyg4GhZvImiUOuh5gKxHRHG2lJM\"" https://baillie.vfitrack.net/api/v1/schedulable_jobs/run_jobs
curl --header "Content-Type: application/json" -d '{}' --header "Accept: application/json" --header "Authorization: Token token=\"integration:c27a535ffdb7ef47bb9d7e7c88ca1a61e963eb72\"" https://test.vfitrack.net/api/v1/schedulable_jobs/run_jobs