describe CommercialInvoiceMapsController do
  ...
  describe "index" do
    ...
    it "should load all mappings" do
      2.times { create(:commercial_invoice_map)}
      get :index
  ...
  describe "update_all" do
    ...
    it "should delete existing items" do
      ...
      create(:commercial_invoice_map, :source_mfid=>"prod_uid", :destination_mfid=>"cil_part_number")
      # this one will be deleted
      create(:commercial_invoice_map, :source_mfid=>"ord_ord_num", :destination_mfid=>"cil_po_number")
