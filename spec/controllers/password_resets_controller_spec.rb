describe PasswordResetsController do
  ...
  describe "create" do
    it "sends password reset message" do
      u = create(:user, disallow_password:false, email:"this_is_a_test@email.com")
    ...
    it "notifies if user has password disallowed" do
      u = create(:user, disallow_password:true, email:"this_is_a_test2@email.com")
  ...
  describe "update" do
    ...
    it "handles expired password (with no current password)" do
      u = create(:user, password_reset:true, password_expired:true, email:"this_is_a_test@email.com", confirmation_token:"555666")
    ...
    it "handles expired password (with invalid current password)" do
      u = create(:user, password_reset:true, password_expired:true, email:"this_is_a_test@email.com", confirmation_token:"555666", password_salt:"ZBX678")
    ...
    it "allows password locked user to reset password" do
      u = create(:user, password_locked:true, password_reset:true, email:"this_is_a_test@email.com", confirmation_token:"555666")
