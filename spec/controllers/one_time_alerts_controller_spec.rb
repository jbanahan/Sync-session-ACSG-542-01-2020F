describe OneTimeAlertsController do
  ...
  describe "index" do
    ...
    it "renders all alerts for admin user when requested" do
      ...
      Timecop.freeze(DateTime.new(2018,3,17)) { get :index, all: true, tab: "expired" }
      expect(response).to be_success
  ...
  describe "create" do
    ...
    it "creates alert for permitted user" do
      ...
      Timecop.freeze(dt) do
        post :create, module_type: "Entry", user_id: user.id
      end
      ...
      expect(response).to redirect_to edit_one_time_alert_path(ota)
    end
  ...
  describe "copy" do
    ...
    it "duplicates alert if populated" do
      ...
      expect{ put :copy, id: alert.id }.to change(OneTimeAlert, :count).from(1).to(2)
      ...
      expect(response).to redirect_to edit_one_time_alert_path(cpy)
  ...
  context "mass update" do
    ...
    describe "mass_delete" do
      ...
      it "deletes multiple alerts for permitted user" do
        ...
        expect{delete :mass_delete, ids: [ota_1.id, ota_3.id, ota_4.id]}.to change(OneTimeAlert, :count).from(4).to 2
  ...
  describe "reference_fields_index" do
    it "assigns fields to the view for admin user" do
      ...
      bi_invoice_number = double "Invoice Number"
      ent_entry_num = double "Entry Number"
      ord_ord_num = double "Order Number"
      prod_uid = double "Unique Identifier"
      shp_ref = double "Reference Number"
