describe HtsController do
  ...
  describe "country" do
    before :each do
      @usa = create(:country, "name"=> "United States", iso_code: "US")
      @tariff1 = create(:official_tariff, hts_code: "12345", chapter: 123, country: @usa)
    end
  ...
  describe "subscribed_countries" do
    before :each do
      @usa = create(:country, "name"=> "United States", iso_code: "US", import_location: true)
      @can = create(:country, "name"=> "Canada", iso_code: "CA", import_location: true)
      @vnm = create(:country, "name"=> "Vietnam", iso_code: "VN", import_location: true)
      @tariff1 = create(:official_tariff, hts_code: "12345", chapter: 123, country: @usa)
      @tariff2 = create(:official_tariff, hts_code: "23456", chapter: 234, country: @can)
      @tariff3 = create(:official_tariff, hts_code: "34567", chapter: 345, country: @vnm)
      @tariff4 = create(:official_tariff, hts_code: "45678", chapter: 456, country: @usa)
    end

    it "should return all countries in your local OfficialTariff table when logged in" do
      u = create(:user); sign_in_as u
