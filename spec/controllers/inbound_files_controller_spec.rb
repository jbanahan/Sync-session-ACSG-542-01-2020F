describe InboundFilesController do
  ...
  let(:inbound_file) do
    Factory(:inbound_file, file_name: "f.txt", s3_bucket: "the_bucket", s3_path: "the_path", receipt_location: "the_folder")
  end
  ...
  describe "send_to_test" do
    ...
    it "sends multiple files" do
      inbound_file2 = Factory(:inbound_file, s3_bucket: "the_bucket2", s3_path: "the_path2")
