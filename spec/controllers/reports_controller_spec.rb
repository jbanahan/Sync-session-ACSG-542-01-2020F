describe ReportsController do
  ...
  describe "Drawback audit report" do
    before(:each) do
      ...
      @u.company.drawback_claims << create(:drawback_claim)
  ...
  describe "SG Duty Due Report" do
    ...
    context "show" do
      ...
      it "renders page for authorized users" do
        ...
        sgi = with_customs_management_id(create(:company, name: 'SGI APPAREL LTD'), 'SGI')
        sgold = with_customs_management_id(create(:company, name: 'S GOLDBERG & CO INC'), 'SGOLD')
        rugged = with_customs_management_id(create(:company, name: 'RUGGED SHARK LLC'), 'RUGGED')
        create(:company)
  ...
  describe "Ascena Duty Savings Report" do
    ...
    let!(:fm) { create(:fiscal_month, company: ascena, year: 2019, month_number: 9) }
  ...
  describe "PVH Canada Duty Assist Report" do
    ...
    let!(:user) { create(:user) }
    let!(:pvh_canada) { create(:company, system_code: "PVHCANADA") }
    let!(:fm) { create(:fiscal_month, company: pvh_canada, year: 2020, month_number: 2, start_date: Date.new(2020, 2, 15)) }
    ...
    context "show" do
      ...
      it "renders for authorized users" do
        create(:fiscal_month, company: pvh_canada, year: 2020, month_number: 1, start_date: Date.new(2020, 1, 15))
  ...
  describe "PVH Duty Assist Report" do
    let(:report_class) { OpenChain::CustomHandler::Pvh::PvhDutyAssistReport }
    let!(:user) { create(:user) }
    let!(:pvh) { create(:company, system_code: "PVH") }
    let!(:fm) { create(:fiscal_month, company: pvh, year: 2020, month_number: 2, start_date: Date.new(2020, 2, 15)) }
    ...
    context "show" do
      ...
      it "renders for authorized users" do
        create(:fiscal_month, company: pvh, year: 2020, month_number: 1, start_date: Date.new(2020, 1, 15))
  ...
  describe "Ascena MPF Savings Report" do
    ...
    let!(:fm) { create(:fiscal_month, company: ascena, year: 2019, month_number: 9, end_date: Date.new(2019, 10, 31)) }
  ...
  describe "Entry Year Over Year Report" do
    ...
    context "show" do
      ...
      it "renders for authorized users, master user" do
        ...
        us_company_1 = with_customs_management_id(create(:importer, name:'US-Z'), '12345')
        us_company_2 = with_customs_management_id(create(:importer, name:'US-A'), '23456')
        ca_company_1 = with_fenix_id(create(:importer, name:'CA-Z'), '12345')
        ca_company_2 = with_fenix_id(create(:importer, name:'CA-A'), '23456')
      ...
      it "renders for authorized users, typical user" do
        us_company_1 = with_customs_management_id(create(:importer, name:'US-A'), '23456')

        user.company.customer = true
        user.company.linked_companies << us_company_1
        user.save!

        us_company_2 = with_customs_management_id(create(:importer, name:'US-Z'), '12345')
        ca_company = with_fenix_id(create(:importer, name:'CA-Z'), '12345')
    ...
    context "run" do
      ...
      it "runs for admin users" do
        ...
        importer_1 = with_customs_management_id(create(:company), 'SYS01')
        importer_2 = with_fenix_id(create(:company), 'SYS02')
        # No match should be made for this even though there is a blank line in the input.
        importer_3 = create(:company, alliance_customer_number:'')
  ...
  describe "US Billing Report" do
    ...
    context "show" do
      ...
      it "renders for authorized user" do
        co_1 = with_customs_management_id(create(:importer, name: "ACME US"), "ACME")
        co_2 = with_fenix_id(create(:importer, name: "ACME CA"), "ACME CA")
  ...
  describe "H&M Canada Drawback Report" do
    ...
    describe "PVH Duty Discount Report" do
      ...
      context "show" do
        ...
        it "renders for authorized users" do
          pvh = create(:company, name:'PVH', system_code:'PVH')
          pvh_ca = create(:company, name:'PVH', system_code:'PVHCANADA')
  ...
  describe "PVH First Cost Savings Report" do
    ...
    context "show" do
      ...
      it "renders for authorized users" do
        pvh = create(:company, name:'PVH', system_code:'PVH')
        another_importer = create(:company, name:'Another Importer', system_code:'imp')
