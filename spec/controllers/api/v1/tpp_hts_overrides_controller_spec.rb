describe Api::V1::TppHtsOverridesController do
  ...
  describe '#index' do
    it 'should find overrides' do
      o = create(:tpp_hts_override, hts_code:'0101010101')
      get :index
  ...
  describe '#show' do
    ...
    it "should fail if user cannot view" do
      ...
      get :show, id: create(:tpp_hts_override).id.to_s
      expect(response).to_not be_success
    end
  end
  ...
  describe '#update' do
    ...
    it 'should fail if changing preference program' do
      ...
      new_tpp = create(:trade_preference_program)
