...
describe Api::V1::AllianceDataController do
  ...
  describe "receive_updated_entry_numbers" do
    it "receives data" do
      ...
      OpenChain::CustomHandler::KewillDataRequester.should_receive(:request_entry_batch_data).with({"1"=>"201503010000", "2"=>"201503020000"})
      OpenChain::CustomHandler::KewillDataRequester.should_receive(:request_entry_batch_data).with({"3"=>"201503030000", "4"=>"201503040000"})
