describe Api::V1::OrdersController do
  ...
  let! (:user) do
    u = create(:master_user, order_edit: true, order_view: true, product_view: true)
    allow_api_access u
    u
  end
  ...
  describe "index" do
    it 'lists orders' do
      create(:order, order_number: '123')
      create(:order, order_number: 'ABC')
      get :index
  ...
  describe "update" do
    let(:order) { create(:order, order_number: 'oldordnum') }
