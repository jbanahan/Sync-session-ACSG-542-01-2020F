describe Api::V1::PortsController do
  ...
  describe "autocomplete" do
    it "should paginate" do
      11.times {|i| create(:port, name: "Name #{i}")}
    ...
    it "should allow name filter" do
      p = create(:port, name:'XabX')
      p2 = create(:port, name:'XdeX')
    ...
    it "searches on schedule d" do
      p = create(:port, name:'XabX', schedule_d_code: "1234", schedule_k_code: "")
    ...
    it "searches on schedule K" do
      p = create(:port, name:'XabX', schedule_d_code: "", schedule_k_code: "12345")
    ...
    it "searches on locode" do
      p = create(:port, name:'XabX', schedule_d_code: "", schedule_k_code: "", unlocode: "LOCOD")
    ...
    it "searches on cbsa port" do
      p = create(:port, name:'XabX', schedule_d_code: "", schedule_k_code: "", cbsa_port: "1234")
    ...
    it "searches on iata code" do
      p = create(:port, name:'XabX', schedule_d_code: "", schedule_k_code: "", cbsa_port: "", iata_code: "IAT")
