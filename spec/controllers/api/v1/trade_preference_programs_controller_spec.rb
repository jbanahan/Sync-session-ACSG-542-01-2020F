describe Api::V1::TradePreferenceProgramsController do
  ...
  describe '#index' do
    it 'should find tpps' do
      ...
      create(:trade_preference_program, origin_country:us, destination_country:ca)
      create(:trade_preference_program, origin_country:ca, destination_country:us)
  ...
  describe '#show' do
    ...
    it 'should fail if user cannot view tpp' do
      ...
      get :show, id: create(:trade_preference_program).id.to_s
      expect(response).to_not be_success
    end
  end
