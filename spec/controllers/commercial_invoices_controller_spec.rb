describe CommercialInvoicesController do
  describe "show" do
    ...
    it "should assign shipment if linked" do
      shipment_line = create(:shipment_line, :quantity=>10)
      order_line = create(:order_line, :product=>shipment_line.product, :price_per_unit=>10.0, :quantity=>100, :order=>create(:order, :vendor=>shipment_line.shipment.vendor))
      inv_line = create(:commercial_invoice_line, :quantity=>10, :commercial_invoice=>@ci)
