describe OpenChain::Report::HmDrawbackImportReport do
  ...
  describe "write_report_to_builder" do
    it "writes to builder" do
      ...
      Factory(:commercial_invoice_tariff, commercial_invoice_line:inv_line_1, hts_code:"123456789", tariff_description:"tar-1",
      ...
      inv_line_2 = Factory(:commercial_invoice_line, commercial_invoice:inv_1, po_number:"PO-A", part_number:"part-B",
                           customs_line_number:2, quantity:6, country_origin_code:"CO", country_export_code:"UT",
                           unit_of_measure:"GA", unit_price:6.88)

      inv_2 = Factory(:commercial_invoice, entry:ent_1, invoice_number:"123460", exchange_rate:0.5)
      # This line has two matching receipt file lines and product XREFs, one tariff.
      inv_line_3 = Factory(:commercial_invoice_line, commercial_invoice:inv_2, po_number:"PO-B", part_number:"part-B",
      ...
      inv_line_4 = Factory(:commercial_invoice_line, commercial_invoice:inv_3, po_number:"PO-C", part_number:"part-C",
