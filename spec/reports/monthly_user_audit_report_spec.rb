...
describe OpenChain::Report::MonthlyUserAuditReport do
  it "sends an email with the correct recipients and a correctly-formatted xls" do
    ...
    Factory(:admin_user, username: "Sailor", email: "sailor@vandegriftinc.com")
    month = Time.now.strftime('%B')

    OpenChain::Report::MonthlyUserAuditReport.run_schedulable
    mail = ActionMailer::Base.deliveries.pop
    
    expect(mail.to).to eq [ "soldier@vandegriftinc.com", "sailor@vandegriftinc.com" ]
