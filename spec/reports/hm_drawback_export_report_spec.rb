describe OpenChain::Report::HmDrawbackExportReport do
  let!(:us_importer) { FactoryBot(:company, system_code:"HENNE", name:"H&M USA") }

  describe "write_report_to_builder" do
    it "writes to builder" do
      ent_1 = FactoryBot(:entry, entry_number:"ent-1", entry_filed_date:Date.new(2017, 3, 5), customer_number:"HMCAD", direct_shipment_date:Date.new(2017, 5, 3))
      inv_1 = FactoryBot(:commercial_invoice, entry:ent_1, invoice_number:"123456-01")
      # This line has a matching I2 and product XREF, and 2 tariffs.
      inv_line_1 = FactoryBot(:commercial_invoice_line, commercial_invoice:inv_1, po_number:"PO-A", part_number:"part-A", line_number:1, quantity:5)
      FactoryBot(:commercial_invoice_tariff, commercial_invoice_line:inv_line_1, hts_code:"123456789")
      FactoryBot(:commercial_invoice_tariff, commercial_invoice_line:inv_line_1, hts_code:"234567890")
      ...
      inv_line_2 = FactoryBot(:commercial_invoice_line, commercial_invoice:inv_1, po_number:"PO-A", part_number:"part-B", line_number:2, quantity:6)

      # This invoice shares an invoice number with invoice #1, but with a different suffix.
      inv_2 = FactoryBot(:commercial_invoice, entry:ent_1, invoice_number:"123456-02")
      # This line has two matching I2s and product XREFs, one tariff.
      inv_line_3 = FactoryBot(:commercial_invoice_line, commercial_invoice:inv_2, po_number:"PO-B", part_number:"part-B", line_number:1, quantity:7)
      FactoryBot(:commercial_invoice_tariff, commercial_invoice_line:inv_line_3, hts_code:"456789012")
      ...
      ent_2 = FactoryBot(:entry, entry_number:"ent-2", entry_filed_date:Date.new(2017, 3, 2), customer_number:"HMCAD", direct_shipment_date:Date.new(2017, 5, 2))
      inv_3 = FactoryBot(:commercial_invoice, entry:ent_2, invoice_number:"123457-01")
      # This line has a matching I2 and product XREF, one tariff.
      inv_line_4 = FactoryBot(:commercial_invoice_line, commercial_invoice:inv_3, po_number:"PO-C", part_number:"part-C", line_number:1, quantity:8)
      FactoryBot(:commercial_invoice_tariff, commercial_invoice_line:inv_line_4, hts_code:"123456789")
      ...
      ent_3 = FactoryBot(:entry, entry_number:"ent-3", entry_filed_date:Date.new(2017, 2, 28), customer_number:"HMCAD", direct_shipment_date:Date.new(2017, 5, 3))
      inv_4 = FactoryBot(:commercial_invoice, entry:ent_3, invoice_number:"123458-01")
      FactoryBot(:commercial_invoice_line, commercial_invoice:inv_4, po_number:"PO-D", part_number:"part-D", line_number:2, quantity:9)

      # This line is ignored because it's after the date range.
      ent_4 = FactoryBot(:entry, entry_number:"ent-4", entry_filed_date:Date.new(2017, 4, 1), customer_number:"HMCAD", direct_shipment_date:Date.new(2017, 5, 3))
      inv_5 = FactoryBot(:commercial_invoice, entry:ent_4, invoice_number:"123459-01")
      FactoryBot(:commercial_invoice_line, commercial_invoice:inv_5, po_number:"PO-E", part_number:"part-E", line_number:3, quantity:10)
