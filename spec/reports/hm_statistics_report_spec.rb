describe OpenChain::Report::HmStatisticsReport do
  ...
  describe "run_report" do
    ...
    it "runs report with basic info" do
      ...
      ent = create(:entry, entry_number: "ent num", export_country_codes: "US", master_bills_of_lading: "master", house_bills_of_lading: "house", release_date: assigned_day, customer_number: "HENNE", transport_mode_code: "40")
      ci = create(:commercial_invoice, entry: ent, invoice_number: "123456")
      cil = create(:commercial_invoice_line, commercial_invoice: ci, hmf: 1, prorated_mpf: 2, cotton_fee: 3)
      cit = create(:commercial_invoice_tariff, commercial_invoice_line: cil, entered_value: 1, duty_amount: 2)

      ent_2 = create(:entry, entry_number: "ent num", export_country_codes: "US", master_bills_of_lading: "master", house_bills_of_lading: "house", release_date: assigned_day, customer_number: "HENNE", transport_mode_code: "10")
      ci_2 = create(:commercial_invoice, entry: ent_2, invoice_number: "123456")
      cil_2 = create(:commercial_invoice_line, commercial_invoice: ci_2, hmf: 1, prorated_mpf: 2, cotton_fee: 3)
      cit_2 = create(:commercial_invoice_tariff, commercial_invoice_line: cil_2, entered_value: 1, duty_amount: 2)
      con = create(:container, entry: ent_2, container_number: "cont num")
  ...
  describe "raw_air_query" do
    let!(:ent) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", house_bills_of_lading: "house", master_bills_of_lading: "master", transport_mode_code: "40", release_date: assigned_day, entry_number: "entry num")}
    let!(:ci) {create(:commercial_invoice, entry: ent, invoice_number: "123456")}
  ...
  describe "raw_ocean_query" do
    let!(:ent) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", transport_mode_code: "10", release_date: assigned_day, entry_number: "entry num")}
    let!(:ci) {create(:commercial_invoice, entry: ent, invoice_number: "123456")}
    let!(:con) {create(:container, entry: ent, container_number: "cont num")}
  ...
  describe "ocean_tu_query" do
    let!(:ent) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", transport_mode_code: "10", release_date: assigned_day, entry_number: "entry num")}
    let!(:ci) {create(:commercial_invoice, entry: ent, invoice_number: "123456")}
    let!(:con_1) {create(:container, entry: ent, container_number: "cont num 1")}
    let!(:con_2) {create(:container, entry: ent, container_number: "cont num 2")}
    let!(:con_3) {create(:container, entry: ent, container_number: "cont num 2")}
  ...
  describe "orders_query" do
    let!(:ent_1) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", transport_mode_code: "10", release_date: assigned_day)}
    let!(:ent_2) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", transport_mode_code: "11", release_date: assigned_day)}
    let!(:ent_3) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", transport_mode_code: "40", release_date: assigned_day)}
    let!(:ent_4) {create(:entry, customer_number: "HENNE", export_country_codes: "DE", transport_mode_code: "41", release_date: assigned_day)}
    let!(:ent_5) {create(:entry, customer_number: "HENNE", export_country_codes: "US", transport_mode_code: "10", release_date: assigned_day)}
    let!(:ci_1) {create(:commercial_invoice, entry: ent_1, invoice_number: "123456")}
    let!(:ci_2) {create(:commercial_invoice, entry: ent_2, invoice_number: "1234567")}
    let!(:ci_3) {create(:commercial_invoice, entry: ent_3, invoice_number: "1234568")}
    let!(:ci_4) {create(:commercial_invoice, entry: ent_4, invoice_number: "123456-7")}
    let!(:ci_5) {create(:commercial_invoice, entry: ent_5, invoice_number: "1234567-8")}
  ...
  describe "totals_query" do
    let!(:ent) {create(:entry, release_date: assigned_day, customer_number: "HENNE")}
    let!(:ci) {create(:commercial_invoice, entry: ent, invoice_number: "123456")}
    let!(:cil) {create(:commercial_invoice_line, commercial_invoice: ci, hmf: 1, prorated_mpf: 2, cotton_fee: 3)}
    let!(:cit) {create(:commercial_invoice_tariff, commercial_invoice_line: cil, entered_value: 1, duty_amount: 2)}
    let!(:cil_2) {create(:commercial_invoice_line, commercial_invoice: ci, hmf: 4, prorated_mpf: 5, cotton_fee: 6)}
    let!(:cit_2) {create(:commercial_invoice_tariff, commercial_invoice_line: cil_2, entered_value: 3, duty_amount: 4)}
