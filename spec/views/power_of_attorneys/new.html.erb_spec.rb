...
describe "power_of_attorneys/new.html.erb" do
  before(:each) do
    assign(:power_of_attorney, stub_model(PowerOfAttorney,
      :company_id => 1,
      :uploaded_by => 1,
  ...
  it "renders new power_of_attorney form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => power_of_attorneys_path, :method => "post" do
