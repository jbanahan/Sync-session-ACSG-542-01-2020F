describe AttachmentArchive do
  describe "attachment_list_json" do
    it "should write entry information" do
      entry = create(:entry, :arrival_date=>1.day.ago, :importer=>create(:company), :broker_reference=>'brokerref')
      invoice = create(:broker_invoice, :entry=>entry, :invoice_date=>2.months.ago)
