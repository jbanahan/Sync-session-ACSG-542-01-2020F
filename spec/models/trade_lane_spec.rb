describe TradeLane do
  ...
  describe '#trade_preference_programs' do
    it 'should return preference programs' do
      tpp1 = create(:trade_preference_program)
      tpp2 = create(:trade_preference_program, origin_country_id:tpp1.origin_country_id, destination_country_id:tpp1.destination_country_id)
      lane = create(:trade_lane, origin_country_id:tpp1.origin_country_id, destination_country_id:tpp1.destination_country_id)
