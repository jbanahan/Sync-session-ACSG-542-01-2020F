describe BusinessValidationTemplate do
  ...
  describe "create_result!" do
    ...
    it "does not snapshot the entity if instructed not to" do
      order = Factory(:order, order_number: "ajklsdfajl")
  ...
  describe "copy_attributes" do
    ...
    let!(:template) do
      Factory(:business_validation_template, delete_pending: true, description: "templ descr", disabled: true, module_type: "Entry",
