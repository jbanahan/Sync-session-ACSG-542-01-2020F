describe FiscalMonth do
  ...
  context "forward/back" do
    let!(:co) { create(:company) }
    let!(:fm_1) { create(:fiscal_month, company: co, month_number: 11, year: 2016, start_date: "2016-11-01", end_date: "2016-01-30") }
    let!(:fm_2) { create(:fiscal_month, company: co, month_number: 12, year: 2016, start_date: "2016-12-01", end_date: "2016-12-31") }
    let!(:fm_3) { create(:fiscal_month, company: co, month_number: 1, year: 2017, start_date: "2017-01-01", end_date: "2017-01-31") }
    let!(:fm_4) { create(:fiscal_month, company: co, month_number: 2, year: 2017, start_date: "2017-02-01", end_date: "2017-02-28") }
  ...
  describe "get" do
    let!(:co) { create(:company) }
    let!(:fm) { create(:fiscal_month, company: co, year: 2017, month_number: 3, start_date: "2017-03-01", end_date: "2017-03-30") }
  ...
  describe "generate_csv" do
    ...
    it "returns 4 column CSV, including only fiscal months belonging to specified company" do
      create(:fiscal_month, company: co, year: 2015, month_number: 2, start_date: date3, end_date: date4)
      create(:fiscal_month, company: co, year: 2015, month_number: 1, start_date: date1, end_date: date2)
      create(:fiscal_month)
