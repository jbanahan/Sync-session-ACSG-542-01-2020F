describe ValidationRuleEntryInvoiceValueMatchesDaPercent do
  ...
  before :each do
    ...
    @invoice = create(:commercial_invoice, invoice_number: "123B", invoice_value_foreign: 100)
    @invoice_line = create(:commercial_invoice_line, commercial_invoice: @invoice, adjustments_amount: 4.5)
    create(:commercial_invoice_line, commercial_invoice: @invoice, adjustments_amount: 4.5)
  end
  ...
  it "fails if the sum of the invoice line's DA amount isn't the target percentage of the invoice's value" do
    create(:commercial_invoice_line, commercial_invoice: @invoice, adjustments_amount: 0.4)
