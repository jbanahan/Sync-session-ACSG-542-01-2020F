describe Address do
  ...
  context "address_hash" do
    it "sets an address hash on save" do
      a = create(:address, name:'myname', line_1:'l1', line_2:'l2', city:'Jakarta')
      a.save!
  ...
  describe "full_address" do
    it "should render address with newlines" do
      a = Address.new(name:'Vandegrift', line_1:'234 Market St', line_2:'5th Floor', line_3:nil, city:'Philadelphia', state:'PA', postal_code:'19106', country:create(:country, iso_code:'US'))
  ...
  describe "full_address_array" do
    let (:address) {
      Address.new(name:'Vandegrift', line_1:'234 Market St', line_2:'5th Floor', line_3:nil, city:'Philadelphia', state:'PA', postal_code:'19106', country:create(:country, iso_code:'US'))
    }
  ...
  context "validations" do
    it "should not allow destroy if in use" do
      a = create(:address)
      create(:shipment, ship_to_id:a.id)
  ...
  describe "in_use" do
    ...
    it "should return true for address linked to custom value" do
      cd = create(:custom_definition, data_type: :integer, module_type: 'Company', is_address: true)
