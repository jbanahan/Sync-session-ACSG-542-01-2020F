describe ValidatesFieldFormat do
  ...
  let (:order_line) { create(:order_line, line_number: 1, hts: "foo", price_per_unit: 10, quantity: 1)}
  ...
  describe "validate_field_format" do
    ...
    it 'handles \w with dates with dt_notregexp' do
      ...
      entry = create(:entry, release_date: Time.zone.now)
    ...
    context "with split field" do
      let (:entry) { create(:entry, customer_references: "XabcY\n XdefY\n XghiY")}
