...
describe ValidationRuleBrokerInvoiceLineFieldFormat do
  before do
    ...
    @bil = Factory(:broker_invoice_line, charge_description: 'Something', charge_amount: 5100)
    @bi = Factory(:broker_invoice, customer_number: '123', broker_invoice_lines: [@bil])
  ...
  it 'should pass if invoice that does not meet search criteria is invalid' do
    ...
    @bad_bil = Factory(:broker_invoice_line, charge_code: '321', charge_amount: 4900)
