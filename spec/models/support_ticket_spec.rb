describe SupportTicket do
  ...
  describe "open scope" do
    it "should return open tickets" do
      find = create(:support_ticket)
      dont_find = create(:support_ticket, :state=>"closed")
  ...
  context "notifications", :disable_delayed_jobs do
    before :each do
      ...
      @st = create(:support_ticket, :requestor=>@requestor, :agent=>@agent, :email_notifications=>true)
