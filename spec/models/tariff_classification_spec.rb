describe TariffClassification do
  ...
  describe "find_effective_tariff" do
    ...
    let (:tariff) { create(:tariff_classification, country: country, tariff_number: "1234567890", effective_date_start: Date.new(2019, 1, 1))}
    let! (:tariff_rate) { create(:tariff_classification_rate, tariff_classification: tariff)}
    ...
    it "returns the record with the effective date closest to the given date" do
      another_tariff = create(:tariff_classification, country: country, tariff_number: "1234567890", effective_date_start: Date.new(2019, 1, 2))
