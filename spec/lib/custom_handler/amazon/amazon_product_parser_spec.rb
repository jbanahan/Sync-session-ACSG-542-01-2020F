describe OpenChain::CustomHandler::Amazon::AmazonProductParser do
  ...
  let! (:country_origin) { Factory(:country, iso_code: "CN") }
  ...
  describe "parse" do 
    ...
    it "updates existing product" do
      p = Factory(:product, importer: importer, unique_identifier: "CMID-HJE9870", name: "Desc")
      subject.process_parts csv_data, user, "file.csv"
    ...
    it "marks parts inactive if instructed" do
      p = Factory(:product, importer: importer, unique_identifier: "CMID-HJE9870")
      csv_data[1][0] = "Delete"
      subject.process_parts csv_data, user, "file.csv"
      p.reload
