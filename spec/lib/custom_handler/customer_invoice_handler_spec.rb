describe OpenChain::CustomHandler::CustomerInvoiceHandler do
  ...
  describe "process" do
    ...
    it "creates new invoices" do
      ...
      expect(inv.factory.name).to eq "create 1"
      expect(inv.factory.system_code).to eq "ACME-FACTORY-create 1"
