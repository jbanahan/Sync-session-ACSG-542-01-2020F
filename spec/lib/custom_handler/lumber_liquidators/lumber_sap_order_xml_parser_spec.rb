...
describe OpenChain::CustomHandler::LumberLiquidators::LumberSapOrderXmlParser do
  describe :parse_dom do
    ...
    it "should create order" do
      ...
      expect(oa.state).to eq 'NJ'
      expect(oa.postal_code).to eq '08816'
      expect(oa.country).to eq @usa
      expect(oa.system_code).to eq '1183'
