...
describe OpenChain::CustomHandler::LumberLiquidators::LumberSapArticleXmlParser do
  describe "parse_dom" do
    before :each do
      ...
      @cdefs = described_class.prep_custom_definitions [:ordln_part_name, :ordln_old_art_number, :prod_sap_extract, :prod_old_article, :class_proposed_hts, :prod_merch_cat, :prod_merch_cat_desc, :prod_overall_thickness]
