describe OpenChain::CustomHandler::LumberLiquidators::LumberShipmentAttachmentFileParser do
  ...
  describe "process_file" do
    ...
    it "processes file with matching shipment" do
      shp = create(:shipment, master_bill_of_lading:'OU812', reference: '555')
    ...
    it "processes file with matching shipment and existing ODS attachment with newer version" do
      shp = create(:shipment, master_bill_of_lading:'OOLU2100046990', reference: '555')
    ...
    it "processes file containing no PDF" do
      user = create(:user, first_name:"Nigel", last_name:"Tufnel", company:create(:company, name:"ACME"))
      create(:mailing_list, name:'Testing', system_code:'ODSNotifications', user:user, email_addresses:"a@b.com,c@d.com, e@f.com")
