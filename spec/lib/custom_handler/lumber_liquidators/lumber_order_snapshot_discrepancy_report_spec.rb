describe OpenChain::CustomHandler::LumberLiquidators::LumberOrderSnapshotDiscrepancyReport do
  ...
  describe "run_report" do
    ...
    it "runs report based on snapshot date filters" do
      vendor = create(:company, name:'Crudco')
      order_1 = create(:order, order_number: '5551234', vendor:vendor, created_at:DateTime.new(2018, 3, 31))
      ...
      shp = create(:shipment, booking_received_date:DateTime.new(2018, 1, 10), departure_date:DateTime.new(2018, 1, 12))
      shp.booking_lines.create! order_line:order_1.order_lines[0]

      order_2 = create(:order, order_number: '5551235', vendor:vendor, created_at:DateTime.new(2018, 3, 25))
      ...
      order_3 = create(:order, order_number: '5551236', vendor:vendor, created_at:DateTime.new(2018, 3, 27))
      ...
      order_4 = create(:order, order_number: '5551237', vendor:vendor, created_at:DateTime.new(2018, 3, 28))
      ...
      order_5 = create(:order, order_number: '5551238', vendor:vendor, created_at:DateTime.new(2018, 3, 29))
    ...
    it "runs report for open orders only" do
      vendor = create(:company, name:'Crudco')
      order_1 = create(:order, order_number: '5551234', vendor:vendor)
      ...
      order_2 = create(:order, order_number: '5551235', vendor:vendor, closed_at: DateTime.new(2018, 5, 2))
