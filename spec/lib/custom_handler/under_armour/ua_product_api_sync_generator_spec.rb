describe OpenChain::CustomHandler::UnderArmour::UaProductApiSyncGenerator do
  ...
  describe "sync" do
    before :each do
      ...
      @tariff = create(:tariff_record, line_number: 1, hts_1: "1234567890", classification: create(:classification, country: create(:country, iso_code: "US"), product: create(:product, name: "Description")))
