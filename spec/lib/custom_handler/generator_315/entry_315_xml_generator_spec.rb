describe OpenChain::CustomHandler::Generator315::Entry315XmlGenerator do
  ...
  describe "create_315_data" do
    let(:entry) do
      create(:entry, broker_reference: "REF", entry_number: "ENT", transport_mode_code: "10", fcl_lcl: "F", carrier_code: "CAR",
    ...
    let!(:port_unlading) { create(:port, schedule_d_code: "9876", name: "Unlading Port") }
    let!(:port_lading) { create(:port, schedule_k_code: "65433", name: "Lading Port") }
