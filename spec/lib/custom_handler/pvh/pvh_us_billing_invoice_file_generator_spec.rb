describe OpenChain::CustomHandler::Pvh::PvhUsBillingInvoiceFileGenerator do
  ...
  let (:shipment) {
    s = create(:shipment, master_bill_of_lading: "MBOL1234567890", house_bill_of_lading: "HBOL987654321", mode: "OCEAN", importer: pvh, last_file_path: "www-vfitrack-net/pvh_gtn_asn_xml/GTNEXUSPVH.xml")
    c = s.containers.create! container_number: "ABCD1234567890", fcl_lcl: "FCL"

    l = create(:shipment_line, shipment: s, container: c, quantity: 10, product: product, linked_order_line_id: order.order_lines.first.id, gross_kgs: 100, invoice_number: "INVOICE1")
    l2 = create(:shipment_line, shipment: s, container: c, quantity: 20, product: product, linked_order_line_id: order.order_lines.second.id, gross_kgs: 200, invoice_number: "INVOICE1")

    l.shipment.reload
  }

  let (:entry) {
    e = create(:entry, entry_number: "ENTRYNUM", broker_reference: "12345", importer_id: pvh.id, customer_number: "PVH", container_numbers: "ABCD1234567890", master_bills_of_lading: "MBOL9999\n MBOL1234567890", transport_mode_code: "10")
  ...
  describe "generate_and_send_container_charges" do
    ...
    it "handles multiple house bills in a single container for ocean LCL shipments" do
      ...
      shipment_2 = create(:shipment, master_bill_of_lading: "MBOL1234567890", house_bill_of_lading: "HBOL2", mode: "OCEAN", importer: pvh)
      container_2 = shipment_2.containers.create! container_number: "ABCD1234567890", fcl_lcl: "LCL"
      shipment_line_2 = create(:shipment_line, shipment: shipment_2, container: container_2, quantity: 10, product: product, linked_order_line_id: order.order_lines.second.id, gross_kgs: 100, invoice_number: "INVOICE2")
      shipment_2.reload
    ...
    it "handles multiple master bills in a single container for ocean FCL shipments" do
      ...
      shipment_2 = create(:shipment, master_bill_of_lading: "MBOL2", house_bill_of_lading: "HBOL2", mode: "OCEAN", importer: pvh)
