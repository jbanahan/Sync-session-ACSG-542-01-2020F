  ...
  describe "parse_file" do
    ...
    context "standard_line_type" do
      before :each do
        ...
        @importer = with_fenix_id(create(:company), "806167003RM0001")
      ...
      it "saves XML information as an Order" do
        ...
        expect(log.identifiers[0].value).to eq @po_number
        expect(log.identifiers[0].module_type).to eq "Order"
        expect(log.identifiers[0].module_id).to eq order.id
      end
      ...
      it "handles Club Monaco buyer" do
        @buyer_id = "0200011987"
        @importer = with_fenix_id(create(:company), "866806458RM0001")
      ...
      it "handles Polo create Stores buyer" do
        @buyer_id = "0200016789"
        @importer = with_fenix_id(create(:company), "806167003RM0002")
