describe OpenChain::CustomHandler::Vandegrift::MaerskCargowiseEntryFileParser do
  ...
  describe "parse" do
    ...
    describe "US" do
      ...
      let! (:broker) { add_system_identifier(create(:company, broker: true, name: "The Broker"), "Filer Code", "595") }
      ...
      it "updates an existing entry" do
        ...
        exist_entry = create(:entry, broker_reference:"BQMJ01119279881", source_system:Entry::CARGOWISE_SOURCE_SYSTEM)
    ...
    describe "Canada" do
      ...
      let! (:broker) { add_system_identifier(create(:company, broker: true, name: "The Broker"), "Filer Code", "59555") }
