...
describe OpenChain::CustomHandler::Vandegrift::KewillMidRequester do

  describe "run_schedulable" do
    subject { described_class }
    it "uses sql proxy client to request mid updates" do
      ...
      expect(sql_proxy).to receive(:request_mid_updates).with Date.new(2016, 10, 10)
