describe OpenChain::CustomHandler::Target::TargetEntryZipFileParser do
  ...
  describe "handle_empty_file" do
    it "logs a reject message and sends an email" do
      create(:mailing_list, system_code: "target_pdf_errors", email_addresses: "a@b.com, c@d.com")
  ...
  describe "process_file" do
    ...
    it "combines all PDFs from a zip file" do
      ...
      create(:entry, customer_number: "ARGENT", source_system: Entry::KEWILL_SOURCE_SYSTEM, broker_reference: "ENT28856",
      ...
      create(:entry, customer_number: "TARGEN", source_system: Entry::FENIX_SOURCE_SYSTEM, broker_reference: "ENT28857",
      ...
      entry = create(:entry, customer_number: "TARGEN", source_system: Entry::KEWILL_SOURCE_SYSTEM, broker_reference: "ENT28858",
      ...
      create(:entry, customer_number: "TARGEN", source_system: Entry::KEWILL_SOURCE_SYSTEM, broker_reference: "ENT28855",
    ...
    it "handles a zip-stitching error" do
      create(:entry, customer_number: "TARGEN", source_system: Entry::KEWILL_SOURCE_SYSTEM, broker_reference: "ENT28858",
