describe OpenChain::CustomHandler::Target::Target820XmlParser do
  ...
  describe "parse" do
    ...
    it "parses XML data to a spreadsheet and emails it" do
      ...
      create(:mailing_list, company: target, system_code: "Target 820 Report", email_addresses: "a@b.com,c@d.com")

      create(:entry, broker_reference: "23920", entry_number: "31625496331", source_system: Entry::KEWILL_SOURCE_SYSTEM, customer_number: "TARGEN")
    ...
    it "raises error if mailing list not found" do
      with_customs_management_id(create(:importer), "TARGEN")
