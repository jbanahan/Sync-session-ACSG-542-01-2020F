describe OpenChain::CustomHandler::AnnInc::AnnBomProductGenerator do
  ...
  let(:product_1) do
    prod = create(:product, unique_identifier: "uid 1")
    prod.update_custom_value! cdefs[:related_styles], "uid 3\nuid 4"
    prod.save!
    prod
  end
  let(:classi_1_1) do
    cl = create(:classification, product: product_1, country: us)
  ...
  let(:tariff_1_1_1) do
    tr = create(:tariff_record, classification: classi_1_1, hts_1: "123456789", line_number: 1)
  ...
  let(:tariff_1_1_2) do
    tr = create(:tariff_record, classification: classi_1_1, hts_1: "912345678", line_number: 2)
  ...
  let(:classi_1_2) do
    cl = create(:classification, product: product_1, country: ca)
    cl.update_custom_value! cdefs[:approved_date], cl.updated_at - 2.days
    cl
  end
  let(:tariff_1_2_1) do
    tr = create(:tariff_record, classification: classi_1_2, hts_1: "135791011", line_number: 1)
  ...
  let(:product_2) do
    prod = create(:product, unique_identifier: "uid 2")
    prod.update_custom_value! cdefs[:related_styles], "uid 5"
    prod
  end
  let(:classi_2_1) do
    cl = create(:classification, product: product_2, country: us)
    cl.find_and_set_custom_value cdefs[:approved_date], cl.updated_at - 2.days
  ...
  let(:tariff_2_1_1) do
    tr = create(:tariff_record, classification: classi_2_1, hts_1: "24681012", line_number: 1)
