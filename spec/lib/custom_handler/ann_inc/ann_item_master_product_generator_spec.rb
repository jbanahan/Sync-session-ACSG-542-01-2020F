describe OpenChain::CustomHandler::AnnInc::AnnItemMasterProductGenerator do
  ...
  let(:classi_1_1) do
    ...
    cl.save!
    t = create(:tariff_record, classification: cl, hts_1: "123456789", line_number: 1)
    t.update_custom_value! cdefs[:set_qty], 5
    create(:tariff_record, classification: cl, hts_1: "987654321", line_number: 2)
    cl
  end
  let(:classi_1_2) do
    cl = create(:classification, product: product_1, country: ca)
    cl.update_custom_value! cdefs[:approved_date], cl.updated_at - 2.days
    create(:tariff_record, classification: cl, hts_1: "135791011", line_number: 1)
    cl
  end
  let(:product_2) do
  ...
  let(:classi_2_1) do
    ...
    cl.save!
    create(:tariff_record, classification: cl, hts_1: "24681012", line_number: 1)
    cl
  end
