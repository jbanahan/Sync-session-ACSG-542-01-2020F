describe OpenChain::CustomHandler::Ascena::AscenaSupplementalFileParser do
  ...
  describe "parse" do
    let!(:ent) { create(:entry, entry_number: "21612345671", broker_reference: "1234567", source_system: Entry::KEWILL_SOURCE_SYSTEM) }
    ...
    context "errors" do
      before { create(:mailing_list, system_code: "ascena_ftz_validations", email_addresses: "tufnel@stonehenge.biz") }
