describe OpenChain::CustomHandler::Ascena::ValidationRuleAscenaFirstSale do
  ...
  describe "run_validation" do
    let (:entry) {
      e = create(:entry, customer_number: "ASCE", entry_filed_date: Date.new(2017, 4, 21))
    ...
    before do
      create(:order, vendor: create(:company, system_code: "ACME"), factory: create(:company, mid: "MID"), order_number: "ASCENA-JST-12345")
      create(:order, vendor: create(:company, system_code: "KONVENIENTZ"), factory: create(:company, mid: "MID2"), order_number: "ASCENA-JST-54321")
    end
