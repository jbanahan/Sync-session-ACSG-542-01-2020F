describe OpenChain::CustomHandler::Ascena::AscenaEntryIsfMismatchReport do
  ...
  describe "run_report" do
    ...
    let! (:entry) {
      e = create(:entry, importer: importer, broker_reference: "REF", entry_number: "ENT", master_bills_of_lading: "MBOL", house_bills_of_lading: "HBOL\n HBOL2", container_numbers: "CONT", transport_mode_code: "10", first_entry_sent_date: ActiveSupport::TimeZone["UTC"].parse("2017-05-01 12:00"))
    ...
    let! (:isf) {
      sf = create(:security_filing, importer: importer, transaction_number: "TRANS", entry_reference_numbers: "REF", master_bill_of_lading: "MBOL", house_bills_of_lading: "HBOL1")
  ...
  describe "run_schedulable" do
    ...
    let! (:ascena) { with_customs_management_id(create(:importer), "ASCE")}
