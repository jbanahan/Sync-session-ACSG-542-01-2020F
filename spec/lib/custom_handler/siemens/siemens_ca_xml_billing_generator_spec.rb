describe OpenChain::CustomHandler::Siemens::SiemensCaXmlBillingGenerator do
  ...
  let(:ent1) { create(:entry, entry_number: "11912345678901", importer: co1, file_logged_date: now, entry_type: "A", importer_tax_id: "807150586RM0001") }
  let(:ent2) { create(:entry, importer: co2, file_logged_date: now - 1.day, entry_type: "A", importer_tax_id: "807150586RM0002") }
  ...
  describe "generate_xml" do
    before do
      ...
      ci = create(:commercial_invoice, entry: ent1, currency: "currency", invoice_number: "inv num", master_bills_of_lading: "mbol1\n mbol2",
                                        house_bills_of_lading: "inv_hbol1\n inv_hbol2", mfid: "mid", net_weight: 5.25, exchange_rate: 1.25)
      cil = create(:commercial_invoice_line, commercial_invoice: ci, vendor_name: "vend name", po_number: "po num", line_number: 1, customs_line_number: 2,
      ...
      create(:commercial_invoice_tariff, commercial_invoice_line: cil, sima_amount: 2.50, excise_amount: 3.50, gst_amount: 4.50, hts_code: "hts1",
      ...
      create(:commercial_invoice_tariff, commercial_invoice_line: cil, sima_amount: 2.75, excise_amount: 3.75, gst_amount: 4.75, duty_amount: 4.10, duty_rate_description: "2.10") # rubocop:disable Layout/LineLength
      pga_line_1 = create(:canadian_pga_line, commercial_invoice_line: cil, batch_lot_number: "batch lot num", brand_name: "brand name", commodity_type: "commodity type",
      ...
      create(:canadian_pga_line, commercial_invoice_line: cil, batch_lot_number: "batch lot num2", commodity_type: "commodity type", program_code: "program code", agency_code: "HC") # rubocop:disable Layout/LineLength
      create(:canadian_pga_line_ingredient, canadian_pga_line: pga_line_1, quality: 0.5, quantity: 5.2, name: "ing name")
      create(:canadian_pga_line_ingredient, canadian_pga_line: pga_line_1, quality: 0.75, quantity: 8.2, name: "ing name 2")
    end
    ...
    it "selects correct data for <Description>" do
      ...
      cil = create(:commercial_invoice_line, commercial_invoice: ci, customs_line_number: 2, line_number: 3)
      create(:commercial_invoice_tariff, commercial_invoice_line: cil, tariff_description: "tariff descr")

      cil_2 = create(:commercial_invoice_line, commercial_invoice: ci, customs_line_number: 3, line_number: 2)
      create(:commercial_invoice_tariff, commercial_invoice_line: cil_2, tariff_description: "tariff descr 2")

      cil_3 = create(:commercial_invoice_line, commercial_invoice: ci, customs_line_number: 2, line_number: 1)
      create(:commercial_invoice_tariff, commercial_invoice_line: cil_3, tariff_description: "tariff descr 3")

      cil_4 = create(:commercial_invoice_line, commercial_invoice: ci, customs_line_number: 2, line_number: 2)
      create(:commercial_invoice_tariff, commercial_invoice_line: cil_4, tariff_description: "tariff descr 4")
