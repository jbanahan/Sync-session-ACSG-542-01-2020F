describe OpenChain::CustomHandler::EddieBauer::EddieBauerPoParser do
  before :each do
    @eddie = create(:company, system_code:'EDDIE')
    @ebcc = create(:company, system_code:'EBCC')
  ...
  describe "parse" do
    ...
    context "with disabled delayed jobs", :disable_delayed_jobs do
      ...
      it "should find existing product" do
        p = create(:product, unique_identifier:'EDDIE-009-8498', importer:@eddie)
        subject.parse(@data)
      ...
      it "should delete and rebuild lines on existing order" do
        p = create(:product, unique_identifier:'EDDIE-009-9999', importer:@eddie)
        line_to_delete = create(:order_line, product:p, order:create(:order, importer:@eddie, order_number:'EDDIE-E0442642-0011'))
      ...
      it "should use existing vendor" do
        ...
        vendor = create(:company, vendor:true, system_code:sys_code)
        subject.parse @data
