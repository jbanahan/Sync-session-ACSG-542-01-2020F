describe OpenChain::CustomHandler::Burlington::Burlington856Parser do
  ...
  describe "process_transaction" do
    ...
    let (:importer) { create(:importer, system_code: "BURLI") }
    ...
    context "standard_order" do
      ...
      let! (:order_1) {
        o = create(:order, order_number: "BURLI-365947702", importer: importer)
      ...
      let! (:order_2) {
        o = create(:order, order_number: "BURLI-364985401", importer: importer)
        ol = o.order_lines.create! product: product, quantity: 100
        ol.update_custom_value! cdefs[:ord_line_buyer_item_number], "13347530"
      ...
      let (:product) {
        p = create(:product, unique_identifier: "BURLI-PART1")
      }
    ...
    context "prepack_order" do
      ...
      let! (:order_1) {
        o = create(:order, order_number: "BURLI-641585114", importer: importer)
      ...
      let (:product_2) {
        p = create(:product, unique_identifier: "BURLI-PART2")
      }

      let (:product_3) {
        p = create(:product, unique_identifier: "BURLI-PART3")
      }
