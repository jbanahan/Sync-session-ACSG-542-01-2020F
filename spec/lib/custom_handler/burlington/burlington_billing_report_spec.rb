describe OpenChain::CustomHandler::Burlington::BurlingtonBillingReport do
  ...
  describe "run_report" do
    ...
    it "generates and emails spreadsheet" do
      entry_1 = create(:entry, entry_number: "entry-cb-1", source_system: "Alliance", po_numbers: "A\n B",
      ...
      entry_2 = create(:entry, entry_number: "entry-ab-2", source_system: "Alliance", po_numbers: "C",
      ...
      entry_3 = create(:entry, entry_number: "entry-ef-3", source_system: "Axis", po_numbers: "D",
      ...
      entry_4 = create(:entry, entry_number: "entry-gh-4", source_system: "Alliance", po_numbers: "E",
      ...
      entry_5 = create(:entry, entry_number: "entry-ij-5", source_system: "Alliance", po_numbers: "F",
