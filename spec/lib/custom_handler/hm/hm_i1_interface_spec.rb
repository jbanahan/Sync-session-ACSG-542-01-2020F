describe OpenChain::CustomHandler::Hm::HmI1Interface do
  ...
  let!(:hm) { with_customs_management_id(FactoryBot(:company), 'HENNE') }
  ...
  describe "update_product" do
    it "updates an existing Product from a CSV row" do
      prod = FactoryBot(:product, unique_identifier: "HENNE-0148762", name: "Large Blue Hooded Sweatshirt", importer_id: hm.id)
  ...
  describe "cv_concat" do
    ...
    let (:product) {
      p = FactoryBot(:product, unique_identifier: "HENNE-0148762")
