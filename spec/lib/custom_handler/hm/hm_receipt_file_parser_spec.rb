describe OpenChain::CustomHandler::Hm::HmReceiptFileParser do
  ...
  describe "process" do
    let!(:importer) { create(:company, system_code:'HENNE') }
    ...
    it "handles missing values and bad dates" do
      create(:mailing_list, name:'Testing', system_code:'HmReceiptFileParserErrors', user:user, email_addresses:"a@b.com, c@d.com")
    ...
    it "handles line-level exceptions" do
      create(:mailing_list, name:'Testing', system_code:'HmReceiptFileParserErrors', user:user, email_addresses:"b@a.com, d@c.com")
