describe OpenChain::CustomHandler::Hm::HmPoLineParser do
  ...
  describe "process_excel" do
    let!(:co) { create(:company, system_code: "HENNE") }
    ...
    context "with already existing record" do
      let!(:ci) { create(:commercial_invoice, importer: co, invoice_number: '424913', destination_code: 'West', mfid: 'ZAGBAFIRIDB', total_quantity: 7, invoice_value_foreign: 9,
      ...
      let!(:cil) { create(:commercial_invoice_line, commercial_invoice: ci, part_number: 'HM-1234' , country_origin_code: 'UK', quantity: 3, unit_price: 8, currency: 'GBP', value_foreign: 10, line_number: 1) }
      let!(:cit) { create(:commercial_invoice_tariff, commercial_invoice_line: cil, hts_code: '3333333333', gross_weight: 6, classification_qty_2: nil, classification_uom_2: nil) }
