describe OpenChain::ActivitySummary do
  ...
  describe "generate_us_entry_summary" do
    it "creates json" do
      ent = create(:entry, import_country_id: us.id, importer_id: create(:company).id, first_release_received_date: '2013-12-25 05:00:00 UTC')
  ...
  describe "generate_ca_entry_summary" do
    it "creates json" do
      ent = create(:entry, import_country_id: ca.id, importer_id: create(:company).id, release_date: '2013-12-25 05:00:00 UTC')
  ...
  describe OpenChain::ActivitySummary::CAEntrySummaryGenerator do
    ...
    it "creates summary section" do
      importer = create(:company)

      create(:entry, import_country_id: ca.id, importer_id: importer.id, arrival_date: '2013-12-24 05:00:00 UTC', release_date: '2013-12-25 05:00:00 UTC',
                      total_duty: 100, total_gst: 50, total_duty_gst: 150, entered_value: 1000, total_invoiced_value: 1100, total_units: 70)
      create(:entry, import_country_id: ca.id, importer_id: importer.id, arrival_date: '2013-12-14 05:00:00 UTC', release_date: '2013-12-15 05:00:00 UTC',
                      total_duty: 200, total_gst: 75, total_duty_gst: 275, entered_value: 1500, total_invoiced_value: 1600, total_units: 40)
      create(:entry, import_country_id: ca.id, importer_id: importer.id, arrival_date: '2013-12-17 05:00:00 UTC', file_logged_date: '2013-12-18 05:00:00 UTC',
                      on_hold: true, total_duty: 50, total_gst: 40, total_duty_gst: 90, entered_value: 60, total_invoiced_value: 66, total_units: 3)
      create(:entry, import_country_id: ca.id, importer_id: importer.id, arrival_date: '2012-12-24 05:00:00 UTC', release_date: '2012-12-25 05:00:00 UTC',
                      total_duty: 200, total_gst: 75, total_duty_gst: 275, entered_value: 1500, total_invoiced_value: 1600, total_units: 40)
    ...
    it "creates k84 section" do
      importer = create(:company, name: 'IMP')
      create(:entry, k84_due_date: Date.new(2012, 12, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 1, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 1, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 1, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 2, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 2, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 2, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 3, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 3, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 3, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      create(:entry, k84_due_date: Date.new(2013, 3, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
      # only find last 3, so don't find this one
      create(:entry, k84_due_date: Date.new(2012, 1, 25), total_duty_gst: 100, import_country_id: ca.id, importer_id: importer.id)
  ...
  describe OpenChain::ActivitySummary::USEntrySummaryGenerator do
    describe "generate_hash" do
      it "creates summary section" do
        ...
        create(:entry, import_country_id: us.id, importer_id: importer.id, transport_mode_code: 40, arrival_date: "2013-12-24 05:00:00 UTC",
        ...
        create(:entry, import_country_id: us.id, importer_id: importer.id, transport_mode_code: 10, arrival_date: "2013-12-14 05:00:00 UTC",
        ...
        create(:entry, import_country_id: us.id, importer_id: importer.id, transport_mode_code: 10, arrival_date: "2013-12-17 05:00:00 UTC",
        ...
        create(:entry, import_country_id: us.id, importer_id: importer.id, transport_mode_code: 10, arrival_date: "2012-12-24 05:00:00 UTC",
        ...
        create(:entry, import_country_id: create(:country).id, importer_id: importer.id, first_release_received_date: 2.days.ago, total_duty: 100,
      ...
      it "creates statements section" do
        importer = create(:company, name: 'IMP')
        create(:entry, import_country_id: us.id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 12, 25),
                        monthly_statement_paid_date: nil, total_duty: 100, total_fees: 50)
        create(:entry, import_country_id: us.id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 11, 25),
                        monthly_statement_paid_date: Date.new(2013, 11, 24), total_duty: 200, total_fees: 100)
        create(:entry, import_country_id: us.id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 11, 25),
                        monthly_statement_paid_date: Date.new(2013, 11, 24), total_duty: 200, total_fees: 100)
        create(:entry, import_country_id: us.id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 10, 25),
                        monthly_statement_paid_date: Date.new(2013, 10, 24), total_duty: 200, total_fees: 100)
        create(:entry, import_country_id: us.id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 9, 25),
        ...
        create(:entry, import_country_id: us.id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 8, 24),
                        monthly_statement_paid_date: Date.new(2013, 8, 24), total_duty: 200, total_fees: 100)
        # don't find for wrong country
        create(:entry, import_country_id: create(:country).id, importer_id: importer.id, monthly_statement_due_date: Date.new(2013, 10, 25),
                        monthly_statement_paid_date: Date.new(2013, 10, 24), total_duty: 200, total_fees: 100)
      ...
      it "creates separate lines per importer_id" do
        imp1 = create(:company, name: 'imp1')
        create(:entry, import_country_id: us.id, importer_id: imp1.id, monthly_statement_due_date: Date.new(2013, 11, 25),
                        monthly_statement_paid_date: Date.new(2013, 11, 24), total_duty: 200, total_fees: 100)
        imp2 = create(:company, name: 'imp2') # linked
        create(:entry, import_country_id: us.id, importer_id: imp2.id, monthly_statement_due_date: Date.new(2013, 11, 25),
                        monthly_statement_paid_date: Date.new(2013, 11, 24), total_duty: 200, total_fees: 100)
        imp3 = create(:company, name: 'imp3') # not linked
        create(:entry, import_country_id: us.id, importer_id: imp3.id, monthly_statement_due_date: Date.new(2013, 11, 25),
                        monthly_statement_paid_date: Date.new(2013, 11, 24), total_duty: 200, total_fees: 100)
      ...
      it "creates top 5 vendors YTD" do
        importer = create(:company)
        ent1 = create(:entry, import_country_id: us.id, first_release_received_date: "2013-12-01", importer_id: importer.id)
        ci1 = create(:commercial_invoice, entry: ent1)
        cil1 = create(:commercial_invoice_line, vendor_name: 'V1', commercial_invoice: ci1)
        create(:commercial_invoice_tariff, entered_value: 100, commercial_invoice_line: cil1)
        create(:commercial_invoice_tariff, entered_value: 150, commercial_invoice_line: cil1)

        ent2 = create(:entry, import_country_id: us.id, first_release_received_date: "2013-11-01", importer_id: importer.id)
        ci2 = create(:commercial_invoice, entry: ent2)
        cil2 = create(:commercial_invoice_line, vendor_name: 'V1', commercial_invoice: ci2)
        create(:commercial_invoice_tariff, entered_value: 100, commercial_invoice_line: cil2)

        ent3 = create(:entry, import_country_id: us.id, first_release_received_date: "2013-12-01", importer_id: importer.id)
        ci3 = create(:commercial_invoice, entry: ent3)
        cil3 = create(:commercial_invoice_line, vendor_name: 'V2', commercial_invoice: ci3)
        create(:commercial_invoice_tariff, entered_value: 100, commercial_invoice_line: cil3)

        ent4 = create(:entry, import_country_id: us.id, first_release_received_date: "2012-11-01", importer_id: importer.id)
        ci4 = create(:commercial_invoice, entry: ent4)
        cil4 = create(:commercial_invoice_line, vendor_name: 'V1', commercial_invoice: ci4)
        create(:commercial_invoice_tariff, entered_value: 100, commercial_invoice_line: cil4)

        # don't find for wrong country
        ent5 = create(:entry, import_country_id: create(:country).id, first_release_received_date: "2013-12-01", importer_id: importer.id)
        ci5 = create(:commercial_invoice, entry: ent5)
        cil5 = create(:commercial_invoice_line, vendor_name: 'V1', commercial_invoice: ci5)
        create(:commercial_invoice_tariff, entered_value: 100, commercial_invoice_line: cil5)
      ...
      it "creates port YTD" do
        ...
        create(:entry, import_country_id: us.id, importer_id: importer.id, entry_port_code: '0001', total_units: 100,
                        first_release_received_date: '2013-12-25 16:00:00 UTC')
        create(:entry, import_country_id: us.id, importer_id: importer.id, entry_port_code: '0001', total_units: 50,
                        first_release_received_date: '2013-12-18 16:00:00 UTC')
        create(:entry, import_country_id: us.id, importer_id: importer.id, entry_port_code: '0002', total_units: 75,
                        first_release_received_date: '2013-12-18 16:00:00 UTC')
        # don't find not released
        create(:entry, import_country_id: us.id, importer_id: importer.id, entry_port_code: '0001', total_units: 60,
                        entry_filed_date: '2013-12-25 16:00:00 UTC', first_release_received_date: nil)
        # don't find for wrong country
        create(:entry, import_country_id: create(:country).id, importer_id: importer.id, entry_port_code: '0001', total_units: 100,
      ...
      it "creates port breakouts" do
        ...
        # don't find for wrong country
        create(:entry, import_country_id: create(:country).id, importer_id: importer.id, entry_port_code: '0001', total_units: 60,
      ...
      it "creates hts by line breakouts" do
        ...
        hts_codes.each_with_index do |h, i|
          ...
          ent1 = create(:entry, import_country_id: us.id, importer_id: importer.id, file_logged_date: "2013-12-20 16:00:00 UTC",
                                 first_release_received_date: '2013-12-25 16:00:00 UTC')
          ci1 = create(:commercial_invoice, entry: ent1)
          cil1 = create(:commercial_invoice_line, commercial_invoice: ci1)
          create(:commercial_invoice_tariff, hts_code: h, commercial_invoice_line: cil1)

          # every other for 4 week
          if i.even?
            ent2 = create(:entry, import_country_id: us.id, importer_id: importer.id, file_logged_date: "2013-12-20 16:00:00 UTC",
                                   first_release_received_date: '2013-12-18 16:00:00 UTC')
            ci2 = create(:commercial_invoice, entry: ent2)
            cil2 = create(:commercial_invoice_line, commercial_invoice: ci2)
            create(:commercial_invoice_tariff, hts_code: h, commercial_invoice_line: cil2)
          end

          # first for open
          if i == 0
            ent3 = create(:entry, import_country_id: us.id, importer_id: importer.id, file_logged_date: "2013-12-20 16:00:00 UTC",
                                   entry_filed_date: '2013-12-26 16:00:00 UTC')
            ci3 = create(:commercial_invoice, entry: ent3)
            cil3 = create(:commercial_invoice_line, commercial_invoice: ci3)
            create(:commercial_invoice_tariff, hts_code: h, commercial_invoice_line: cil3)
          end

          # wrong country
          if i == 0
            ent4 = create(:entry, import_country_id: create(:country).id, importer_id: importer.id, file_logged_date: "2013-12-20 16:00:00 UTC",
                                   entry_filed_date: '2013-12-26 16:00:00 UTC')
            ci4 = create(:commercial_invoice, entry: ent4)
            cil4 = create(:commercial_invoice_line, commercial_invoice: ci4)
            create(:commercial_invoice_tariff, hts_code: h, commercial_invoice_line: cil4)
          end
        end
      ...
      it "creates unpaid duty breakouts" do
        ...
        company = create(:company, name: 'Acme', importer: true)
        company.update(linked_companies: [company])
        create(:entry, importer_id: company.id, customer_name: company.name, first_release_received_date: first_release_received_date,
    ...
    describe "single_company_unpaid_duty" do
      ...
      it "doesn't include unreleased entries in totals" do
        create(:entry, importer_id: company.id, first_release_received_date: nil, duty_due_date: date2, total_duty: 600, total_fees: 650)
      ...
      it "doesn't include in totals entries with duty_due_date before today" do
        create(:entry, importer_id: company.id, first_release_received_date: first_release_received_date, duty_due_date: date3,
      ...
      it "doesn't include in totals entries on monthly statement" do
        create(:entry, importer_id: company.id, first_release_received_date: first_release_received_date, duty_due_date: date1,
  ...
  describe "create_by_release_range_query" do
    ...
    let!(:e1) do
      create(:entry, importer: importer, file_logged_date: "2013-12-20 16:00:00 UTC", first_release_received_date: '2014-01-01 15:00:00 UTC',
                      entry_filed_date: '2013-12-25', import_country_id: us.id, source_system: 'Alliance')
    end

    let!(:e2) do
      create(:entry, importer: importer, file_logged_date: "2013-12-20 16:00:00 UTC", first_release_received_date: '2014-01-07 15:00:00 UTC',
                      entry_filed_date: '2013-12-25', import_country_id: us.id, source_system: 'Alliance')
    end
    ...
    it "excludes entries for other importers" do
      e2.update! importer: create(:company)
  ...
  describe "create_by_release_range_download" do
    it "creates spreadsheet of summary detail" do
      ...
      create(:entry, importer: (imp = create :company, name: "Acme"), import_country: us, entry_filed_date: date1,
  ...
  describe "DutyDetail" do
    ...
    let(:date2) { date1 + 15 }
    let(:first_release_received_date) { date1.to_datetime }
    let(:company) { create(:company, name: 'Acme', master: true) }
    let(:non_master_company) { create(:company, name: "Emca") }
    let(:user) { create(:user, company: company) }
    let(:port1) { create(:port, schedule_d_code: '1234', name: 'Boston') }
    let(:port2) { create(:port, schedule_d_code: '4321', name: 'New York') }

    # included in totals
    let(:ent1) do
      create(:entry, importer_id: company.id, entry_port_code: port1.schedule_d_code, entry_number: '12345678912',
                      first_release_received_date: first_release_received_date, duty_due_date: date1, total_duty: 100, total_fees: 200)
    end

    let(:ent2) do
      create(:entry, importer_id: company.id, entry_port_code: port1.schedule_d_code, entry_number: '21987654321',
                      first_release_received_date: first_release_received_date, duty_due_date: date1, total_duty: 200, total_fees: 250)
    end

    let(:ent3) do
      create(:entry, importer_id: company.id, entry_port_code: port1.schedule_d_code, entry_number: '53471126928',
                      first_release_received_date: first_release_received_date, duty_due_date: date2, total_duty: 300, total_fees: 350)
    end

    let(:ent4) do
      create(:entry, importer_id: company.id, entry_port_code: port2.schedule_d_code, entry_number: '14215923867',
                      first_release_received_date: first_release_received_date, duty_due_date: date2, total_duty: 400, total_fees: 450)
    end

    let(:ent5) do
      create(:entry, importer_id: company.id, entry_port_code: port2.schedule_d_code, entry_number: '59172148623',
                      first_release_received_date: first_release_received_date, duty_due_date: date2, total_duty: 500, total_fees: 550)
    end

    # excluded from totals
    let(:ent6) do
      create(:entry, importer_id: company.id, entry_port_code: port2.schedule_d_code, entry_number: '95711284263',
                      first_release_received_date: nil, duty_due_date: date2, total_duty: 600, total_fees: 650)
    end

    let(:ent7) do
      create(:entry, importer_id: company.id, entry_port_code: port2.schedule_d_code, entry_number: '36248211759',
                      first_release_received_date: first_release_received_date, duty_due_date: date3, total_duty: 700, total_fees: 750)
    end

    let(:ent8) do
      create(:entry, importer_id: company.id, entry_port_code: port2.schedule_d_code, entry_number: '63422811579',
    ...
    let(:ent9) do
      create(:entry, importer_id: non_master_company.id, entry_port_code: port1.schedule_d_code, entry_number: '23821946175',
                      first_release_received_date: first_release_received_date, duty_due_date: date1, total_duty: 900,
                      total_fees: 950)
    end

    let(:ent10) do
      create(:entry, importer_id: company.id, entry_port_code: port2.schedule_d_code, entry_number: '7654321987',
  ...
  describe OpenChain::ActivitySummary::EntrySummaryDownload do
    ...
    let(:linked_1) { with_customs_management_id(create(:company, name: "Super Pow"), "POW") }
    let(:linked_2) { create(:company, name: "Walshop") }
    let(:imp)  { with_customs_management_id(create(:company, linked_companies: [linked_1, linked_2], system_code: "SYSCODE", name: "Konvenientz"), "KONV") }
    let(:user) { create(:user, company: imp, time_zone: "Central Time (US & Canada)") }
    ...
    describe "ReportEmailer" do
      ...
      let(:imp) { with_customs_management_id(create(:company, name: "ACME"), "AC") }
      let(:gen) { described_class.new(imp.id, "US") }
      let(:user) { create(:user, first_name: "Nigel", last_name: "Tufnel", email: "tufnel@stonehenge.biz", company: imp) }
      let(:mailing_list) { create(:mailing_list, user: user, company: imp, email_addresses: 'mailinglist@domain.com')}
      ...
      describe "update_args" do
        ...
        context "with user" do
          let(:user) { create(:user, first_name: "Nigel", last_name: "Tufnel", email: "tufnel@stonehenge.biz") }
    ...
    describe "run_schedulable" do
      it "creates and emails spreadsheet to a mailing list" do
        ...
        mailing_list = create(:mailing_list, name: 'Test', user: user, company: user.company, email_addresses: 'mailinglist@domain.com')
        stub_master_setup
