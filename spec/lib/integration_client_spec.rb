...
describe OpenChain::IntegrationClientCommandProcessor do
  ...
  context 'request type: remote_file' do
    ...
    it 'should send data to CSM Sync custom handler if feature enabled and path contains _csm_sync' do
      ...
      OpenChain::S3.stub(:download_to_tempfile).with(OpenChain::S3.integration_bucket_name,'12345', {:filename=>["a", ".xls"]}).and_return(@t)
    ...
    it 'should send date to Kewill parser if Alliance is enabled and path contains _kewill_isf' do
      ...
      OpenChain::S3.stub(:download_to_tempfile).with(OpenChain::S3.integration_bucket_name,'12345', {:filename=>["x", ".y"]}).and_return(@t)
      OpenChain::IntegrationClientCommandProcessor.process_command(cmd).should == @success_hash 
    end
    ...
    it 'should create linkable attachment if linkable attachment rule match' do
      ...
      OpenChain::S3.stub(:download_to_tempfile).with(OpenChain::S3.integration_bucket_name,'12345', {:filename=>["this", ".csv"]}).and_return(@t)
      OpenChain::IntegrationClientCommandProcessor.process_command(cmd).should == @success_hash 
    ...
    context 'imported_file' do
      ...
      it 'should create if path contains to_chain' do
        ...
        OpenChain::S3.stub(:download_to_tempfile).with(OpenChain::S3.integration_bucket_name,'12345', {:filename=>["myfile", ".csv"]}).and_return(@t)
        OpenChain::IntegrationClientCommandProcessor.process_command(cmd).should == @success_hash
      ...
      context 'errors' do
        it 'should fail on bad user' do
          ...
          OpenChain::S3.stub(:download_to_tempfile).with(OpenChain::S3.integration_bucket_name,'12345', {:filename=>["file", ".csv"]}).and_return(@t)
    ...
    it 'should return error if not imported_file or linkable_attachment' do
      ...
      OpenChain::S3.stub(:download_to_tempfile).with(OpenChain::S3.integration_bucket_name,'12345', {:filename=>["path", ""]}).and_return(@t)
