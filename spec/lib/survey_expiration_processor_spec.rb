describe OpenChain::SurveyExpirationProcessor, type: :mailer do
  ...
  let!(:master_setup) { stub_master_setup }
	...
	before :each do
		...
		@survey_1_sub1 = create(:user, email: "survey_1_sub1@example.com")
		@survey_1_sub2 = create(:user, email: "survey_1_sub2@example.com")
		@survey_1_sub3 = create(:user, email: "survey_1_sub3@example.com")
		@survey_2_sub1 = create(:user, email: "survey_2_sub1@example.com")
		@survey_2_sub2 = create(:user, email: "survey_2_sub2@example.com")
		@survey_2_sub3 = create(:user, email: "survey_2_sub3@example.com")
		@survey_1 = create(:survey, :name=>"survey_1", :email_subject=>"survey_1_subject", :email_body=>"survey_1_body", :ratings_list=>"survey_1_rating", expiration_days: 1)
		@survey_2 = create(:survey, :name=>"survey_2", :email_subject=>"survey_2_subject", :email_body=>"survey_2_body", :ratings_list=>"survey_2_rating", expiration_days: 1)
		...
		@survey_1_response_1 = create(:survey_response, rating: "survey_1_response_1_rating", survey: @survey_1, email_sent_date: Time.now - 3.days, subtitle: "test subtitle 1.1")
		@survey_1_response_2 = create(:survey_response, rating: "survey_1_response_2_rating", survey: @survey_1, email_sent_date: Time.now - 3.days)
		@survey_1_response_3 = create(:survey_response, rating: "survey_1_response_3_rating", survey: @survey_1, email_sent_date: Time.now - 3.days, subtitle: "test subtitle 1.3")
		@survey_2_response_1 = create(:survey_response, rating: "survey_2_response_1_rating", survey: @survey_2, email_sent_date: Time.now - 3.days, subtitle: "test subtitle 2.1")
		@survey_2_response_2 = create(:survey_response, rating: "survey_2_response_2_rating", survey: @survey_2, email_sent_date: Time.now - 3.days)
		@survey_2_response_3 = create(:survey_response, rating: "survey_2_response_3_rating", survey: @survey_2, email_sent_date: Time.now - 3.days, subtitle: "test subtitle 2.3")
