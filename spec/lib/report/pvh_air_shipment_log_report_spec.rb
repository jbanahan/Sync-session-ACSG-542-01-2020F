describe OpenChain::Report::PvhAirShipmentLogReport do
  ...
  describe "run_report" do
    ...
    let(:container1) { create(:container, container_number: "CONT1", quantity: 5, entry: create(:entry, broker_reference: "123", customer_number: "PVH", master_bills_of_lading: "ABCD", house_bills_of_lading: "EFGH", transport_mode_code: 40, arrival_date: Time.zone.now, worksheet_date: Time.zone.parse("2014-10-01 00:00"), entry_port_code: port.schedule_d_code, store_names: "A\n B", customer_references: "A123 10/1/14\n1234\nB123")) }
    let(:entry) { container1.entry }
    let!(:container2) { create(:container, container_number: "CONT1", quantity: 10, entry: entry) }
