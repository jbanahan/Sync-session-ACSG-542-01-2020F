  ...
  describe '#run_report' do
    ...
    let :make_countries do
      ...
      @country_rates.each_key do |iso|
        r[iso] = create(:country, :iso_code=>iso, import_location:true)
      end
      r
    end
    let :make_tariffs do
    ...
    let :make_product do
      ...
      @country_rates.each_key do |iso|
        country = Country.find_by iso_code: iso
        create(:tariff_record, hts_1:'1234567890', classification:create(:classification, country:country, product:p))
      end
      p
    end
    ...
    context 'override scenarios' do
      it 'should use expected duty rate from classification' do
        ...
        create(:trade_lane, origin_country:countries['MX'], destination_country:countries['CN'], tariff_adjustment_percentage:'1')
        make_tariffs
        p = make_product
      ...
      it 'should use tpp decimal rate' do
        ...
        countries = make_countries
        create(:trade_lane, origin_country:countries['MX'], destination_country:countries['CN'], tariff_adjustment_percentage:'1')
        create(:trade_preference_program, origin_country:countries['MX'], destination_country:countries['CN'], tariff_identifier:'CNMX')
        make_tariffs
        create(:spi_rate, country:countries['CN'], special_rate_key:OfficialTariff.first.special_rate_key, program_code:'CNMX', rate:BigDecimal('0.02'))
        p = make_product
        f = described_class.run_report user, season: 'FW17'
        results = CSV.read(f.path)
        expect(results.length).to eq 2
      ...
      it 'should use tpp decimal rate with lane uplift' do
        ...
        countries = make_countries
        create(:trade_lane, origin_country:countries['MX'], destination_country:countries['CN'], tariff_adjustment_percentage:'1')
        create(:trade_preference_program, origin_country:countries['MX'], destination_country:countries['CN'], tariff_identifier:'CNMX', tariff_adjustment_percentage:'2.1')
        make_tariffs
        create(:spi_rate, country:countries['CN'], special_rate_key:OfficialTariff.first.special_rate_key, program_code:'CNMX', rate:BigDecimal('0.02'))
        p = make_product
        f = described_class.run_report user, season: 'FW17'
      ...
      it 'should use tpp decimal rate with override' do
        ...
        countries = make_countries
        create(:trade_lane, origin_country:countries['MX'], destination_country:countries['CN'], tariff_adjustment_percentage:'1')
        tpp = create(:trade_preference_program, origin_country:countries['MX'], destination_country:countries['CN'], tariff_identifier:'CNMX', tariff_adjustment_percentage:'2.1')
        create(:tpp_hts_override, trade_preference_program:tpp, hts_code:'123', rate:'6.2')
        make_tariffs
        create(:spi_rate, country:countries['CN'], special_rate_key:OfficialTariff.first.special_rate_key, program_code:'CNMX', rate:BigDecimal('0.02'))
        p = make_product
        f = described_class.run_report user, season: 'FW17'
      ...
      it 'should use most specific override' do
        ...
        tpp = create(:trade_preference_program, origin_country:countries['MX'], destination_country:countries['CN'], tariff_identifier:'CNMX', tariff_adjustment_percentage:'2.1')
        create(:tpp_hts_override, trade_preference_program:tpp, hts_code:'123', rate:'6.2')
        create(:tpp_hts_override, trade_preference_program:tpp, hts_code:'1234', rate:'8')
        make_tariffs
        create(:spi_rate, country:countries['CN'], special_rate_key:OfficialTariff.first.special_rate_key, program_code:'CNMX', rate:BigDecimal('0.02'))
        p = make_product
        f = described_class.run_report user, season: 'FW17'
    ...
    context 'special cases' do
      it 'should only use first tariff record for sets' do
        ...
        create(:trade_lane, origin_country:countries['MX'], destination_country:countries['CN'], tariff_adjustment_percentage:'1')
        make_tariffs
        create(:official_tariff, hts_code:'987654321', common_rate_decimal:0.99, country_id:countries['CN'].id)
        p = make_product
