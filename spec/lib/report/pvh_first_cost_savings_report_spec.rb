describe OpenChain::Report::PvhFirstCostSavingsReport do
  ...
  describe "run_report" do
    ...
    it "generates spreadsheet" do
      ...
      entry_1 = Factory(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-1", transport_mode_code: "10", fiscal_date: Date.new(2018, 12, 15),
      ...
      entry_2 = Factory(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-2", transport_mode_code: "40",
      ...
      Factory(:entry, customer_number: "NOT PVH", entry_number: "entry-3", fiscal_date: Date.new(2018, 12, 25))
      Factory(:entry, customer_number: "PVH", entry_number: "entry-4", fiscal_date: Date.new(2018, 12, 14))
      Factory(:entry, customer_number: "PVH", entry_number: "entry-5", fiscal_date: Date.new(2019, 1, 15))
    ...
    it "defaults years when not provided" do
      ...
      entry = Factory(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-1", transport_mode_code: "10",
      ...
      # These should be excluded.
      Factory(:entry, customer_number: "PVH", entry_number: "entry-4", fiscal_date: Date.new(2019, 8, 14))
      Factory(:entry, customer_number: "PVH", entry_number: "entry-5", fiscal_date: Date.new(2019, 9, 15))
    ...
    it "generates spreadsheet for the current fiscal quarter" do
      ...
      entry_1 = Factory(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-1", transport_mode_code: "10",
      ...
      factory_1 = Factory(:factory, name: "factory-1")
      ord_1 = Factory(:order, importer_id: pvh.id, order_number: "pvh-PO-A", factory_id: factory_1.id)
      ord_1_line = ord_1.order_lines.create! line_number: 1, product_id: Factory(:product, importer_id: pvh.id).id, price_per_unit: BigDecimal("5.67")
      ...
      # These should be excluded.
      Factory(:entry, customer_number: "PVH", entry_number: "entry-3", fiscal_date: Date.new(2019, 6, 13))
      Factory(:entry, customer_number: "PVH", entry_number: "entry-4", fiscal_date: Date.new(2019, 9, 15))
