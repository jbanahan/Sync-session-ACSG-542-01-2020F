describe OpenChain::Report::InboundFileReport do
  ...
  describe "run" do
    ...
    let (:company) { create(:company, name: "Company", system_code: "CODE") }
    ...
    context "with default settings" do
      ...
      it "emails to mailing list" do
        ...
        MailingList.create! company_id: company.id, user_id: create(:user).id, system_code: "list", name: "List", email_addresses: "you@there.com"
    ...
    it "restricts by system codes" do
      company = create(:company, system_code: "TEST")
