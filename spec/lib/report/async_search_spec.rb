describe OpenChain::Report::AsyncSearch do
  ...
  describe "run_and_email_report" do
    ...
    let (:search_setup) { create(:search_setup, name: "Test", user: user, download_format: "xlsx") }

    it "runs report and emails it to a mailing list" do
      mailing_list = create(:mailing_list, user: user, company: company, email_addresses: 'report@report.com')
