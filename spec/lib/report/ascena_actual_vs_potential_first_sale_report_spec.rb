describe OpenChain::Report::AscenaActualVsPotentialFirstSaleReport do
  ...
  describe "run_schedulable" do
    def create_data
      ...
      fact1 = Factory(:company, name: "fact1")
      fact2 = Factory(:company, name: "fact2")
      ...
      fm_year_start = Factory(:fiscal_month, company: co, year: 2016, month_number: 1, start_date: '2016-01-01', end_date: '2016-01-31')
      ...
      ci1 = Factory(:commercial_invoice, entry: ent1, invoice_value: 20)
      cil1_1 = Factory(:commercial_invoice_line, commercial_invoice: ci1, po_number: 'po num1_1', contract_amount: 10, value: 8, mid: 'mid1')
      cil1_2 = Factory(:commercial_invoice_line, commercial_invoice: ci1, po_number: 'po num1_2', contract_amount: 9, value: 6, mid: 'mid1')
      cil1_3 = Factory(:commercial_invoice_line, commercial_invoice: ci1, po_number: 'po num1_3', contract_amount: 8, value: 5, mid: 'mid2')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil1_1, duty_amount: 3, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil1_2, duty_amount: 5, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil1_3, duty_amount: 2, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num1_1', vendor: vend1, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num1_2', vendor: vend1, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num1_3', vendor: vend2, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      # season
      ent2 = Factory(:entry, customer_number: 'ASCE', fiscal_date: '2016-07-04', fiscal_month: 9, fiscal_year: 2016)
      ci2 = Factory(:commercial_invoice, entry: ent2, invoice_value: 20)
      cil2_1 = Factory(:commercial_invoice_line, commercial_invoice: ci2, po_number: 'po num2_1', contract_amount: 10, value: 8, mid: 'mid1')
      cil2_2 = Factory(:commercial_invoice_line, commercial_invoice: ci2, po_number: 'po num2_2', contract_amount: 9, value: 6, mid: 'mid1')
      cil2_3 = Factory(:commercial_invoice_line, commercial_invoice: ci2, po_number: 'po num2_3', contract_amount: 8, value: 5, mid: 'mid2')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil2_1, duty_amount: 3, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil2_2, duty_amount: 5, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil2_3, duty_amount: 2, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num2_1', vendor: vend1, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num2_2', vendor: vend1, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num2_3', vendor: vend2, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      # ytd
      ent3 = Factory(:entry, customer_number: 'ASCE', fiscal_date: '2016-01-04', fiscal_month: 9, fiscal_year: 2016)
      ci3 = Factory(:commercial_invoice, entry: ent3, invoice_value: 20)
      cil3_1 = Factory(:commercial_invoice_line, commercial_invoice: ci3, po_number: 'po num3_1', contract_amount: 10, value: 8, mid: 'mid1')
      cil3_2 = Factory(:commercial_invoice_line, commercial_invoice: ci3, po_number: 'po num3_2', contract_amount: 9, value: 6, mid: 'mid1')
      cil3_3 = Factory(:commercial_invoice_line, commercial_invoice: ci3, po_number: 'po num3_3', contract_amount: 8, value: 5, mid: 'mid2')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil3_1, duty_amount: 3, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil3_2, duty_amount: 5, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil3_3, duty_amount: 2, entered_value: 6)
      ...
      ci4 = Factory(:commercial_invoice, entry: ent4, invoice_value: 20)
      cil4_1 = Factory(:commercial_invoice_line, commercial_invoice: ci4, po_number: 'po num4_1', contract_amount: 0, value: 8, mid: 'mid1')
      cil4_2 = Factory(:commercial_invoice_line, commercial_invoice: ci4, po_number: 'po num4_2', contract_amount: 0, value: 6, mid: 'mid1')
      cil4_3 = Factory(:commercial_invoice_line, commercial_invoice: ci4, po_number: 'po num4_3', contract_amount: 0, value: 5, mid: 'mid2')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil4_1, duty_amount: 3, duty_rate: 2, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil4_2, duty_amount: 5, duty_rate: 3, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil4_3, duty_amount: 2, duty_rate: 4, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num4_1', vendor: vend1, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num4_2', vendor: vend1, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num4_3', vendor: vend2, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      # season
      ent5 = Factory(:entry, customer_number: 'ASCE', fiscal_date: '2016-07-04', fiscal_month: 9, fiscal_year: 2016)
      ci5 = Factory(:commercial_invoice, entry: ent5, invoice_value: 20)
      cil5_1 = Factory(:commercial_invoice_line, commercial_invoice: ci5, po_number: 'po num5_1', contract_amount: 0, value: 8, mid: 'mid1')
      cil5_2 = Factory(:commercial_invoice_line, commercial_invoice: ci5, po_number: 'po num5_2', contract_amount: 0, value: 6, mid: 'mid1')
      cil5_3 = Factory(:commercial_invoice_line, commercial_invoice: ci5, po_number: 'po num5_3', contract_amount: 0, value: 5, mid: 'mid2')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil5_1, duty_amount: 3, duty_rate: 2, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil5_2, duty_amount: 5, duty_rate: 3, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil5_3, duty_amount: 2, duty_rate: 4, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num5_1', vendor: vend1, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num5_2', vendor: vend1, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num5_3', vendor: vend2, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      # ytd
      ent6 = Factory(:entry, customer_number: 'ASCE', fiscal_date: '2016-01-04', fiscal_month: 9, fiscal_year: 2016)
      ci6 = Factory(:commercial_invoice, entry: ent6, invoice_value: 20)
      cil6_1 = Factory(:commercial_invoice_line, commercial_invoice: ci6, po_number: 'po num6_1', contract_amount: 0, value: 8, mid: 'mid1')
      cil6_2 = Factory(:commercial_invoice_line, commercial_invoice: ci6, po_number: 'po num6_2', contract_amount: 0, value: 6, mid: 'mid1')
      cil6_3 = Factory(:commercial_invoice_line, commercial_invoice: ci6, po_number: 'po num6_3', contract_amount: 0, value: 5, mid: 'mid2')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil6_1, duty_amount: 3, duty_rate: 2, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil6_2, duty_amount: 5, duty_rate: 3, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil6_3, duty_amount: 2, duty_rate: 4, entered_value: 6)
      ...
      ci7 = Factory(:commercial_invoice, entry: ent7, invoice_value: 20)
      cil7_1 = Factory(:commercial_invoice_line, commercial_invoice: ci7, po_number: 'po num7_1', contract_amount: 0, value: 8, mid: 'mid3')
      cil7_2 = Factory(:commercial_invoice_line, commercial_invoice: ci7, po_number: 'po num7_2', contract_amount: 0, value: 6, mid: 'mid3')
      cil7_3 = Factory(:commercial_invoice_line, commercial_invoice: ci7, po_number: 'po num7_3', contract_amount: 0, value: 5, mid: 'mid4')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil7_1, duty_amount: 3, duty_rate: 2, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil7_2, duty_amount: 5, duty_rate: 3, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil7_3, duty_amount: 2, duty_rate: 4, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num7_1', vendor: vend3, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num7_2', vendor: vend3, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num7_3', vendor: vend4, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      # season
      ent8 = Factory(:entry, customer_number: 'ASCE', fiscal_date: '2016-07-04', fiscal_month: 9, fiscal_year: 2016)
      ci8 = Factory(:commercial_invoice, entry: ent8, invoice_value: 20)
      cil8_1 = Factory(:commercial_invoice_line, commercial_invoice: ci8, po_number: 'po num8_1', contract_amount: 0, value: 8, mid: 'mid3')
      cil8_2 = Factory(:commercial_invoice_line, commercial_invoice: ci8, po_number: 'po num8_2', contract_amount: 0, value: 6, mid: 'mid3')
      cil8_3 = Factory(:commercial_invoice_line, commercial_invoice: ci8, po_number: 'po num8_3', contract_amount: 0, value: 5, mid: 'mid4')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil8_1, duty_amount: 3, duty_rate: 2, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil8_2, duty_amount: 5, duty_rate: 3, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil8_3, duty_amount: 2, duty_rate: 4, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num8_1', vendor: vend3, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num8_2', vendor: vend3, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num8_3', vendor: vend4, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      # ytd
      ent9 = Factory(:entry, customer_number: 'ASCE', fiscal_date: '2016-01-04', fiscal_month: 9, fiscal_year: 2016)
      ci9 = Factory(:commercial_invoice, entry: ent9, invoice_value: 20)
      cil9_1 = Factory(:commercial_invoice_line, commercial_invoice: ci9, po_number: 'po num9_1', contract_amount: 0, value: 8, mid: 'mid3')
      cil9_2 = Factory(:commercial_invoice_line, commercial_invoice: ci9, po_number: 'po num9_2', contract_amount: 0, value: 6, mid: 'mid3')
      cil9_3 = Factory(:commercial_invoice_line, commercial_invoice: ci9, po_number: 'po num9_3', contract_amount: 0, value: 5, mid: 'mid4')
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil9_1, duty_amount: 3, duty_rate: 2, entered_value: 5)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil9_2, duty_amount: 5, duty_rate: 3, entered_value: 10)
      Factory(:commercial_invoice_tariff, commercial_invoice_line: cil9_3, duty_amount: 2, duty_rate: 4, entered_value: 6)
      Factory(:order, order_number: 'ASCENA-po num9_1', vendor: vend3, factory: fact1).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num9_2', vendor: vend3, factory: fact2).update_custom_value!(agent_cdef, 'agent')
      Factory(:order, order_number: 'ASCENA-po num9_3', vendor: vend4, factory: fact1).update_custom_value!(agent_cdef, 'agent')
    end
  ...
  describe "SavingsQueryRunner" do
    ...
    describe "savings_query" do
      before do
        ...
        vendor = Factory(:company, name: "vend")
        factory = Factory(:company, name: "fact")
        o = Factory(:order, order_number: "ASCENA-po num", vendor: vendor, factory: factory)
        o.update_custom_value!(@cdefs[:ord_selling_agent], 'agent')
        ent = Factory(:entry, customer_number: 'ASCE')
        ci = Factory(:commercial_invoice, entry: ent)
        cil1 = Factory(:commercial_invoice_line, commercial_invoice: ci, po_number: "po num", contract_amount: 10, value: 7, mid: "MID")
        cil2 = Factory(:commercial_invoice_line, commercial_invoice: ci, po_number: "po num", contract_amount: 9, value: 5, mid: "MID")
        Factory(:commercial_invoice_tariff, commercial_invoice_line: cil1, duty_amount: 4.5, duty_rate: 0.2, entered_value: 8)
        Factory(:commercial_invoice_tariff, commercial_invoice_line: cil2, duty_amount: 3, duty_rate: 0.4, entered_value: 6)
      end
  ...
  describe "DetailQueryGenerator" do
    ...
    describe "detail_query" do
      ...
      before do
        ...
        vendor = Factory(:company, name: 'vend')
        factory = Factory(:company, name: 'fact')
        @ent = Factory(:entry, customer_number: 'ASCE', entry_number: 'ent num', entry_filed_date: '2016-01-01', first_release_date: '2016-02-01', fiscal_month: 1)
        ci = Factory(:commercial_invoice, entry: @ent, invoice_number: 'inv num', invoice_value: 3)
        @cil = Factory(:commercial_invoice_line, commercial_invoice: ci, mid: 'cil mid', country_origin_code: 'coo', po_number: 'po num', part_number: 'part num', quantity: 6, unit_price: 2, contract_amount: 4, value: 8)
        Factory(:commercial_invoice_tariff, commercial_invoice_line: @cil, duty_rate: 2, duty_amount: 3, entered_value: 4)
