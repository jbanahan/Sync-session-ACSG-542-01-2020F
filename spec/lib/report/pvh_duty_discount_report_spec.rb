describe OpenChain::Report::PvhDutyDiscountReport do
  ...
  describe "run_report" do
    ...
    it "generates spreadsheet" do
      ...
      entry_1 = create(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-1", arrival_date: Date.new(2018, 12, 13),
      ...
      inv_1_line_1 = inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 10, value: BigDecimal("40.20"),
                                                            entered_value_7501: 33, part_number: "part-A", container: cont_1,
                                                            add_to_make_amount: BigDecimal("2.22"), first_sale: false,
                                                            contract_amount: BigDecimal("44.44"), non_dutiable_amount: BigDecimal("7.65")
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "235679012", duty_rate: BigDecimal(".333"), entered_value: nil
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "990379013", duty_rate: BigDecimal(".25"), entered_value: 22, special_tariff: true
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "990279014", duty_rate: BigDecimal(".10"), entered_value: 11, special_tariff: true
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "235679015", duty_rate: BigDecimal(".02"), entered_value: nil
      inv_1_line_2 = inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 11, value: BigDecimal("51.21"),
                                                            entered_value_7501: 44, part_number: "part-B", container: cont_1,
                                                            add_to_make_amount: BigDecimal("1.21"), first_sale: nil,
                                                            contract_amount: BigDecimal("45.45"), non_dutiable_amount: BigDecimal("7.64")
      ...
      inv_1_line_first_sale = inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 11, value: BigDecimal("51.21"),
                                                                     entered_value_7501: 44, part_number: "part-B", container: cont_1,
                                                                     add_to_make_amount: BigDecimal("1.21"), first_sale: true,
                                                                     contract_amount: BigDecimal("46.46"), non_dutiable_amount: BigDecimal("7.63")
      inv_1_line_first_sale.commercial_invoice_tariffs.create! hts_code: "356790123", duty_rate: BigDecimal(".667"), entered_value: 44
      # Should be excluded because of no non-dutiable amount (ocean entry).
      inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 12, value: BigDecimal("20.20"), part_number: "part-A",
                                             entered_value_7501: 33, container: cont_1, add_to_make_amount: BigDecimal("0.20"),
                                             contract_amount: BigDecimal("44.44"), first_sale: false, non_dutiable_amount: BigDecimal("0")
      inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 13, value: BigDecimal("20.20"), part_number: "part-A",
                                             entered_value_7501: 33, container: cont_1, add_to_make_amount: BigDecimal("0.20"),
      ...
      entry_2 = create(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-2", arrival_date: Date.new(2019, 1, 12),
      ...
      inv_2_line = inv_2.commercial_invoice_lines.create! po_number: "PO-C", quantity: 12, value: BigDecimal("72.22"),
                                                          entered_value_7501: 35, part_number: "part-C", container: cont_2,
      ...
      create(:entry, customer_number: "NOT PVH", entry_number: "entry-3", fiscal_date: Date.new(2018, 12, 25), transport_mode_code: '10')
      create(:entry, customer_number: "PVH", entry_number: "entry-4", fiscal_date: Date.new(2018, 12, 14), transport_mode_code: '10')
      create(:entry, customer_number: "PVH", entry_number: "entry-5", fiscal_date: Date.new(2019, 1, 15), transport_mode_code: '10')
      ...
      expect(detail_sheet[0]).to eq ["Customs Entry Number", "Vendor Invoice Number", "PO Number", "Shipment Number",
                                     "PO Line", "HTS Number", "ETA", "Vendor Invoice Value", "Duty Assist Amount",
                                     "Dutiable Value", "Duty Adj Amount", "Duty Savings", "Duty Rate PCT", "First Cost - PO",
      ...
      expect(summary_sheet[0]).to eq ["Customs Entry Number", "ETA", "Vendor Invoice Value", "Duty Assist Amount",
                                      "Duty Adj Amount", "Dutiable Value", "Duty Difference", "Duty Savings", "Mode of Transport"]
    ...
    it "defaults years when not provided" do
      ...
      entry = create(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-1", arrival_date: Date.new(2019, 8, 13),
      ...
      inv_line = inv.commercial_invoice_lines.create! po_number: "PO-A", quantity: 10, value: BigDecimal("20.20"), part_number: "part-A",
                                                      ...
                                                      contract_amount: BigDecimal("44.44"), freight_amount: BigDecimal("7.65")
      ...
      inv.commercial_invoice_lines.create! po_number: "PO-A", quantity: 11, value: BigDecimal("20.20"), part_number: "part-A",
                                           entered_value_7501: 33, container: cont, add_to_make_amount: BigDecimal("0.20"),
                                           contract_amount: BigDecimal("44.44"), freight_amount: BigDecimal("0")
      inv.commercial_invoice_lines.create! po_number: "PO-A", quantity: 12, value: BigDecimal("20.20"), part_number: "part-A",
                                           entered_value_7501: 33, container: cont, add_to_make_amount: BigDecimal("0.20"),
      ...
      create(:entry, customer_number: "PVH", entry_number: "entry-4", fiscal_date: Date.new(2019, 8, 14), transport_mode_code: '40')
      create(:entry, customer_number: "PVH", entry_number: "entry-5", fiscal_date: Date.new(2019, 9, 16), transport_mode_code: '40')
    ...
    it "generates spreadsheet for the current fiscal quarter" do
      ...
      inv_1 = entry_1.commercial_invoices.create! invoice_number: "inv-1"
      cont_1 = Container.create! container_number: "cont-1"
      inv_1_line_1 = inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 10, contract_amount: BigDecimal("40.20"),
                                                            entered_value_7501: 33, part_number: "part-A", container: cont_1,
                                                            add_to_make_amount: BigDecimal("2.22"), non_dutiable_amount: BigDecimal("7.65")
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "235679012", duty_rate: BigDecimal(".333"), entered_value: nil
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "990379013", duty_rate: BigDecimal(".25"), entered_value: 22, special_tariff: true
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "990279014", duty_rate: BigDecimal(".10"), entered_value: 11, special_tariff: true
      inv_1_line_1.commercial_invoice_tariffs.create! hts_code: "235679015", duty_rate: BigDecimal(".02"), entered_value: nil
      inv_1_line_2 = inv_1.commercial_invoice_lines.create! po_number: "PO-A", quantity: 11, contract_amount: BigDecimal("51.21"),
                                                            entered_value_7501: 44, part_number: "part-B", container: cont_1,
      ...
      inv_2 = entry_2.commercial_invoices.create! invoice_number: "inv-2"
      cont_2 = Container.create! container_number: "cont-2"
      inv_2_line = inv_2.commercial_invoice_lines.create! po_number: "PO-C", quantity: 12, contract_amount: BigDecimal("72.22"),
                                                          entered_value_7501: 35, part_number: "part-C", container: cont_2,
      ...
      # These should be excluded based on date.
      create(:entry, customer_number: "PVH", entry_number: "entry-4", fiscal_date: Date.new(2019, 6, 13), transport_mode_code: '10')
      create(:entry, customer_number: "PVH", entry_number: "entry-5", fiscal_date: Date.new(2019, 9, 15), transport_mode_code: '10')
    ...
    it "appropriately handles null number values and absent order/factory content" do
      ...
      entry = create(:entry, importer_id: pvh.id, customer_number: "PVH", entry_number: "entry-1",
                              arrival_date: Date.new(2018, 12, 13), fiscal_date: Date.new(2018, 12, 22), transport_mode_code: "10")
      inv = entry.commercial_invoices.create! invoice_number: "inv-1"
      cont = Container.create! container_number: "cont-1"
      inv_line = inv.commercial_invoice_lines.create! po_number: "PO-A", quantity: nil, contract_amount: nil,
                                                      part_number: "part-A", container: cont, add_to_make_amount: nil, non_dutiable_amount: BigDecimal("20.20"), value: nil
    ...
    it "sends email if address provided" do
      ...
      expect(mail.subject).to eq("PVH Duty Discount Report")
      expect(mail.body).to include("Attached is the &quot;Duty Discount Report, 2019-1&quot; based on ACH Due Date.")
    ...
    it "handles quarterly, biannual variations" do
      ...
      temp = temp_files.last
      expect(temp.original_filename).to eq "PVH_Duty_Discount_US_FISCAL_DESC_2019-09-30.xlsx"

      reader = XlsxTestReader.new(temp.path).raw_workbook_data
      sheet = reader["Detail"]
      expect(sheet.length).to eq 2
      expect(sheet[0][0]).to eq('Customs Entry Number')
