describe OpenChain::Report::AnnMonthlyBrokerInvoiceReport do
  ...
  let(:ent) { Factory(:entry, po_numbers: "INV NUM\n INV NUM2", importer:  Factory(:company, system_code: "ATAYLOR")) }
  ...
  let(:raw_row_1) { ["", "1100", "1003709", Date.new(2017, 3, 15), "", "INV NUM", 100, "USD", "", "Foo Debit", Date.new(2017, 3, 15), "USD1", "INV NUM\n INV NUM2", "INV NUM", "200190", "S", 90, "U1", "Foo Debit", "", "309401", ""] }
  let(:raw_row_2) { ["", "1100", "1003709", Date.new(2017, 3, 15), "", "INV NUM", 100, "USD", "", "Customs Entry", Date.new(2017, 3, 15), "USD1", "INV NUM\n INV NUM2", "INV NUM", "200190", "S", 10, "U1", "Customs Entry", "", "309401", ""] }
  let(:raw_row_3) { ["", "1100", "1003709", Date.new(2017, 3, 15), "", "INV NUM2", 25, "USD", "", "Bar Credit", Date.new(2017, 3, 15), "USD1", "INV NUM\n INV NUM2", "INV NUM2", "200190", "H", 25, "U1", "Bar Credit", "", "309401", ""] }
  ...
  describe "query" do
    ...
    it "doesn't return invoice lines with charge_type 'D'" do
      line2.update_attributes! charge_type: 'D'
      q = subject.query(ent.importer.id, '2017-03-01', '2017-03-31')
      res = ActiveRecord::Base.connection.execute q
      results = []
      res.each { |r| results << r }
  ...
  describe "arrange_rows" do
    it "turns raw data into header/detail rows" do
      ...
      expect(subject.arrange_rows [raw_row_1, raw_row_2, raw_row_3]).to eq [["H", "1100", "1003709", Date.new(2017, 3, 15), "", "INV NUM", 100, "USD", "", "Customs Entry", Date.new(2017, 3, 15), "USD1", "INV NUM\n INV NUM2", "INV NUM", "200190", "S", 10, "U1", "Customs Entry", "", "309401", ""],
                                                                            ["D", "1100", "1003709", Date.new(2017, 3, 15), "", "INV NUM2", "", "USD", "", "Bar Credit", Date.new(2017, 3, 15), "USD1", "INV NUM\n INV NUM2", "INV NUM2", "200190", "H", 25, "U1", "Bar Credit", "", "309401", ""],
                                                                            ["D", "1100", "1003709", Date.new(2017, 3, 15), "", "INV NUM", "", "USD", "", "Foo Debit", Date.new(2017, 3, 15), "USD1", "INV NUM\n INV NUM2", "INV NUM", "200190", "S", 90, "U1", "Foo Debit", "", "309401", ""]]
    end
  end

  describe "compile_invoices" do
    it "chunks query results by invoice" do
      invoice1_raw = [["", "", "", "", "", "INV NUM1", "", "", "", "Foo Debit"], ["", "", "", "", "", "INV NUM1", "", "", "", "Bar Debit"], ["", "", "", "", "", "INV NUM1", "", "", "", "Baz Debit"]]
  ...
  describe 'run_schedulable' do
    ...
    it "sends email w/ correct data" do
      Timecop.freeze(DateTime.new(2017, 4, 2)) { described_class.run_schedulable('email' => 'tufnel@stonehenge.biz', 'cc' => ['st-hubbins@hellhole.co.uk', 'smalls@sharksandwich.net']) }
      ...
      Tempfile.open('att') do |t|
        ...
        expect(sheet.row(1)).to eq ["H", "1100", "1003709", "03-14-17", nil, "INV NUM", "100.0", "USD", nil, "Customs Entry", "03-14-17", "USD1", "INV NUM", "INV NUM", "200190", "S", "10.0", "U1", "Customs Entry", nil, "309401", nil]
        expect(sheet.row(2)).to eq ["D", "1100", "1003709", "03-14-17", nil, "INV NUM", nil, "USD", nil, "Foo Debit", "03-14-17", "USD1", "INV NUM", "INV NUM", "200190", "S", "90.0", "U1", "Foo Debit", nil, "309401", nil]
        expect(sheet.row(3)).to eq ["H", "1100", "1003709", "03-14-17", nil, "INV NUM2", "25.0", "USD", nil, "Bar Credit", "03-14-17", "USD1", "INV NUM", "INV NUM2", "200190", "H", "25.0", "U1", "Bar Credit", nil, "309401", nil]
      end
    end
  end
