describe OpenChain::Report::KitchenCraftBillingReport do
  ...
  context "run" do
    ...
    it 'should handle different user timezones in input and output' do
      ...
      expect(sheet.row(1)[7]).to eq(Date.new(2013, 3, 31))
    end
  end
end