describe OpenChain::Report::PumaDivisionQuarterBreakdown do
  ...
  describe "run_report" do
    ...
    def make_entry importer, release_date, counter
      Factory(:entry, importer_id:importer.id, release_date:release_date, entered_value:(123.45+counter),
    ...
    it "generates spreadsheet" do
      ...
      importer_not_puma = Factory(:company, name:'Crudco Bitter Rival')
