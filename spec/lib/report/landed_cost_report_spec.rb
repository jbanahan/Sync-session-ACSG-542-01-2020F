describe OpenChain::Report::LandedCostReport do
  before :each do
    ...
    @entry1 = create(:entry, :customer_number=>"CUST", :broker_reference => "BROK REF 1", :release_date=>(Time.zone.now - 1.day), :entry_number=>"1", :transport_mode_code=>"2", :customer_references=>"3\n4")
    @entry2 = create(:entry, :customer_number=>"CUST", :broker_reference => "BROK REF 2", :release_date=>Time.zone.now, :entry_number=>"5", :transport_mode_code=>"6", :customer_references=>"7\n8")
  end
