describe OpenChain::FiscalMonthReminder do
  ...
  let(:co) { create(:company, name: "ACME", system_code: "ac", fiscal_reference: "release_date") }

  describe "fiscal_months_remaining" do
    let!(:fm_fut_1) { create(:fiscal_month, company: co, start_date: '20160301', end_date: "20160331") }
    let!(:fm_fut_2) { create(:fiscal_month, company: co, start_date: '20160401', end_date: "20160430") }
    let!(:fm_current) { create(:fiscal_month, company: co, start_date: '20160201', end_date: "20160229") }
  ...
  describe "companies_needing_update" do
    it "returns list of companies needing update" do
      co
      co_2 = create(:company, name: "Konvenientz", system_code: "Ko", fiscal_reference: "release_date")
      7.times { create(:fiscal_month, company: co, start_date: '20160301') }
