...
if File.exist?("config/pepsi.pem") && ["pepsi", "pepsitest"].include?(MasterSetup.get.system_code)
  spid = "pepsi.vfitrack.net"
  saml_target = ("pepsi" == MasterSetup.get.system_code) ? "https://idp.mypepsico.com/affwebservices/public/saml2sso" : "https://idp.ite.mypepsico.com/affwebservices/public/saml2sso"
